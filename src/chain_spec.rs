...
fn session_keys(grandpa: GrandpaId, babe: BabeId, im_online: ImOnlineId, authority_discovery: AuthorityDiscoveryId) -> SessionKeys {
    SessionKeys {
        babe,
        grandpa,
        im_online,
...
fn testnet_genesis(
    ...
    GenesisConfig {
        ...
        pallet_collective_Instance1: Some(GovernanceCommitteeConfig {
            members: vec![
