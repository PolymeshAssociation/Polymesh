...
impl RemarkBuilder {
	...
	pub fn new(client: Arc<FullClient<polymesh_runtime_develop::RuntimeApi, GeneralExecutor>>) -> Self {
		Self { client }
	}
}
...
impl TransferBuilder {
	/// Creates a new [`Self`] from the given client.
	pub fn new(client: Arc<FullClient<polymesh_runtime_develop::RuntimeApi, GeneralExecutor>>, dest: AccountId, value: Balance) -> Self {
