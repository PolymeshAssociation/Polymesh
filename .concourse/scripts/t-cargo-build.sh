...
cp    ${GIT_DIR}/target/release/wbuild/polymesh-runtime-testnet-v1/polymesh_runtime_testnet-v1.compact.wasm ${ARTIFACT_DIR}/polymesh_runtime_testnet-v1.${VERSION}.wasm
