...
class IdentitySegment extends React.Component {
    constructor() {
        super()
    ...
    render() {
        return <Segment style={{ margin: '1em' }} padded>
            <Header as='h2'>
                ...
                <Header.Content>
                    Polymesh Identity
                { <Header.Subheader>Dave (5DAAnrj7VHTznn2AWBemMuyBwZWs6FNFjdyVXUeYum3PTXFy) is the signer.</Header.Subheader> }
                </Header.Content>
            </Header>
            <div style={{ paddingBottom: '1em' }}></div>
            <AccountIdBond bond={this.destination} />
            <TransactButton
                content="Create Issuer"
                icon='id badge'
                tx={{
                    sender: runtime.indices.tryIndex("5DAAnrj7VHTznn2AWBemMuyBwZWs6FNFjdyVXUeYum3PTXFy"),
                    call: calls.identity.createIssuer(runtime.indices.tryIndex(this.destination))
                }}
            />
        </Segment>
    }
