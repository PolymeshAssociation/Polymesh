...
mod serde_hash {
        ...
        D: Deserializer<'de>,
    {
        ...
        let mut hash = [0u8; 32];
        hex::decode_to_slice(value, &mut hash).map_err(D::Error::custom)?;
        Ok(hash)
    }
}
...
pub enum ProtocolInitializationMethod {
    ...
    ContextHash(#[cfg_attr(feature = "serde", serde(with = "serde_hash"))] BackendContextHash),
}
...
pub struct BackendModuleDefinition {
    ...
    #[cfg_attr(feature = "serde", serde(with = "serde_hash"))]
