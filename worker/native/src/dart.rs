...
#[derive(Clone, Debug)]
pub struct NativeDartModuleInstance;

impl BackendModuleInstance for NativeDartModuleInstance {
...
#[derive(Clone, Debug)]
pub struct NativeDartModule;

impl BackendModule for NativeDartModule {
    fn instantiate(&self) -> Option<Box<dyn BackendModuleInstance>> {
        Some(Box::new(NativeDartModuleInstance))
    }
}
