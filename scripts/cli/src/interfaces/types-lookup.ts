...
declare module '@polkadot/types/lookup' {
  ...
  export interface FrameSystemEventRecord extends Struct {
    ...
    readonly event: PolymeshRuntimeCiRuntimeEvent;
    readonly topics: Vec<H256>;
  }

  /** @name PolymeshRuntimeCiRuntimeEvent (20) */
  export interface PolymeshRuntimeCiRuntimeEvent extends Enum {
  ...
  /** @name PalletCorporateActionsDistributionEvent (142) */
  ...
  /** @name PolymeshCommonUtilitiesCheckpointEvent (148) */
  ...
  /** @name PolymeshCommonUtilitiesCheckpointStoredSchedule (151) */
  ...
  /** @name PolymeshPrimitivesCalendarCheckpointSchedule (152) */
  ...
  /** @name PolymeshPrimitivesCalendarCalendarPeriod (153) */
  ...
  /** @name PolymeshPrimitivesCalendarCalendarUnit (154) */
  ...
  /** @name PalletComplianceManagerEvent (156) */
  ...
  /** @name PolymeshPrimitivesComplianceManagerComplianceRequirement (157) */
  ...
  /** @name PolymeshPrimitivesCondition (159) */
  ...
  /** @name PolymeshPrimitivesConditionConditionType (160) */
  ...
  /** @name PolymeshPrimitivesConditionTargetIdentity (162) */
  ...
  /** @name PolymeshPrimitivesConditionTrustedIssuer (164) */
  ...
  /** @name PolymeshPrimitivesConditionTrustedFor (165) */
  ...
  /** @name PolymeshPrimitivesIdentityClaimClaimType (167) */
  ...
  /** @name PalletCorporateActionsEvent (169) */
  ...
  /** @name PalletCorporateActionsTargetIdentities (170) */
  ...
  /** @name PalletCorporateActionsTargetTreatment (171) */
  ...
  /** @name PalletCorporateActionsCorporateAction (173) */
  ...
  /** @name PalletCorporateActionsCaKind (174) */
  ...
  /** @name PalletCorporateActionsBallotEvent (182) */
  ...
  /** @name PalletCorporateActionsBallotBallotTimeRange (183) */
  export interface PalletCorporateActionsBallotBallotTimeRange extends Struct {
    readonly start: u64;
    readonly end: u64;
  }

  /** @name PalletCorporateActionsBallotBallotMeta (184) */
  ...
  /** @name PalletCorporateActionsBallotMotion (187) */
  ...
  /** @name PalletPipsProposalData (204) */
  ...
  /** @name PalletPipsProposalState (205) */
  ...
  /** @name PalletProtocolFeeRawEvent (218) */
  ...
  /** @name PalletSettlementRawEvent (223) */
  ...
  /** @name PalletSettlementVenueType (226) */
  ...
  /** @name PalletSettlementSettlementType (228) */
  ...
  /** @name PolymeshCommonUtilitiesStatisticsEvent (234) */
  ...
  /** @name PolymeshPrimitivesStatisticsTransferManager (235) */
  ...
  /** @name PalletStoFundraiserTier (242) */
  ...
  /** @name PalletStoFundraiserStatus (243) */
  ...
  /** @name PalletTreasuryRawEvent (244) */
  ...
  /** @name PolymeshCommonUtilitiesBaseEvent (249) */
  ...
  /** @name PolymeshCommonUtilitiesExternalAgentsEvent (251) */
  ...
  /** @name PolymeshCommonUtilitiesRelayerRawEvent (252) */
  ...
  /** @name PalletRewardsRawEvent (253) */
  ...
  /** @name PalletTestUtilsRawEvent (254) */
  ...
  /** @name FrameSystemLastRuntimeUpgradeInfo (258) */
  export interface FrameSystemLastRuntimeUpgradeInfo extends Struct {
    readonly specVersion: Compact<u32>;
    readonly specName: Text;
  }

  /** @name FrameSystemCall (261) */
  ...
  /** @name FrameSystemLimitsBlockWeights (265) */
  ...
  /** @name FrameSupportWeightsPerDispatchClassWeightsPerClass (266) */
  ...
  /** @name FrameSystemLimitsWeightsPerClass (267) */
  ...
  /** @name FrameSystemLimitsBlockLength (268) */
  export interface FrameSystemLimitsBlockLength extends Struct {
    readonly max: FrameSupportWeightsPerDispatchClassU32;
  }

  /** @name FrameSupportWeightsPerDispatchClassU32 (269) */
  ...
  /** @name FrameSupportWeightsRuntimeDbWeight (270) */
  export interface FrameSupportWeightsRuntimeDbWeight extends Struct {
    readonly read: u64;
    readonly write: u64;
  }

  /** @name SpVersionRuntimeVersion (271) */
  ...
  /** @name SpConsensusBabeAppPublic (279) */
  export interface SpConsensusBabeAppPublic extends SpCoreSr25519Public {}

  /** @name SpConsensusBabeDigestsNextConfigDescriptor (282) */
  ...
  /** @name SpConsensusBabeBabeEpochConfiguration (288) */
  ...
  /** @name SpSessionMembershipProof (293) */
  ...
  /** @name PalletBalancesBalanceLock (306) */
  ...
  /** @name PolymeshCommonUtilitiesBalancesReasons (307) */
  ...
  /** @name FrameSupportWeightsWeightToFeeCoefficient (314) */
  ...
  /** @name PolymeshPrimitivesIdentity (315) */
  ...
  /** @name PolymeshPrimitivesSecondaryKey (317) */
  export interface PolymeshPrimitivesSecondaryKey extends Struct {
    readonly signer: PolymeshPrimitivesSecondaryKeySignatory;
    readonly permissions: PolymeshPrimitivesSecondaryKeyPermissions;
  }

  /** @name PalletIdentityClaim1stKey (319) */
  ...
  /** @name PolymeshPrimitivesSecondaryKeyApiLegacyExtrinsicPermissions (328) */
  ...
  /** @name PolymeshPrimitivesSecondaryKeyApiLegacyPalletPermissions (331) */
  ...
  /** @name PolymeshCommonUtilitiesIdentitySecondaryKeyWithAuth (333) */
  ...
  /** @name PolymeshPrimitivesInvestorZkproofDataV1InvestorZKProofData (335) */
  export interface PolymeshPrimitivesInvestorZkproofDataV1InvestorZKProofData extends PolymeshPrimitivesInvestorZkproofDataV1Signature {}

  /** @name PolymeshPrimitivesInvestorZkproofDataV1Signature (336) */
  export interface PolymeshPrimitivesInvestorZkproofDataV1Signature extends Struct {
    readonly r: PolymeshPrimitivesInvestorZkproofDataV1CompressedRistretto;
    readonly s: PolymeshPrimitivesInvestorZkproofDataV1Scalar;
  }

  /** @name PolymeshPrimitivesInvestorZkproofDataV1CompressedRistretto (337) */
  export interface PolymeshPrimitivesInvestorZkproofDataV1CompressedRistretto extends U8aFixed {}

  /** @name PolymeshPrimitivesInvestorZkproofDataV1Scalar (338) */
  export interface PolymeshPrimitivesInvestorZkproofDataV1Scalar extends Struct {
    readonly bytes: U8aFixed;
  }

  /** @name ConfidentialIdentityClaimProofsScopeClaimProof (339) */
  export interface ConfidentialIdentityClaimProofsScopeClaimProof extends Struct {
    readonly proofScopeIdWellformed: ConfidentialIdentityClaimProofsSignature;
    readonly proofScopeIdCddIdMatch: ConfidentialIdentityClaimProofsZkProofData;
    readonly scopeId: ConfidentialIdentityClaimProofsRistrettoPoint;
  }

  /** @name ConfidentialIdentityClaimProofsSignature (340) */
  export interface ConfidentialIdentityClaimProofsSignature extends Struct {
    readonly r: ConfidentialIdentityClaimProofsCompressedRistretto;
    readonly s: ConfidentialIdentityClaimProofsScalar;
  }

  /** @name ConfidentialIdentityClaimProofsCompressedRistretto (341) */
  export interface ConfidentialIdentityClaimProofsCompressedRistretto extends U8aFixed {}

  /** @name ConfidentialIdentityClaimProofsScalar (342) */
  export interface ConfidentialIdentityClaimProofsScalar extends Struct {
    readonly bytes: U8aFixed;
  }

  /** @name ConfidentialIdentityClaimProofsZkProofData (343) */
  export interface ConfidentialIdentityClaimProofsZkProofData extends Struct {
    readonly challengeResponses: Vec<ConfidentialIdentityClaimProofsScalar>;
    readonly subtractExpressionsRes: ConfidentialIdentityClaimProofsRistrettoPoint;
    readonly blindedScopeDidHash: ConfidentialIdentityClaimProofsRistrettoPoint;
  }

  /** @name ConfidentialIdentityClaimProofsRistrettoPoint (345) */
  export interface ConfidentialIdentityClaimProofsRistrettoPoint extends ConfidentialIdentityClaimProofsEdwardsPoint {}

  /** @name ConfidentialIdentityClaimProofsEdwardsPoint (346) */
  export interface ConfidentialIdentityClaimProofsEdwardsPoint extends Struct {
    readonly x: ConfidentialIdentityClaimProofsFieldElement;
    readonly y: ConfidentialIdentityClaimProofsFieldElement;
    readonly z: ConfidentialIdentityClaimProofsFieldElement;
    readonly t: ConfidentialIdentityClaimProofsFieldElement;
  }

  /** @name ConfidentialIdentityClaimProofsFieldElement (347) */
  export interface ConfidentialIdentityClaimProofsFieldElement extends Vec<u64> {}
  ...
  /** @name PolymeshCommonUtilitiesGroupInactiveMember (351) */
  ...
  /** @name PolymeshRuntimeCiRuntimeCall (354) */
  export interface PolymeshRuntimeCiRuntimeCall extends Enum {
    readonly isSystem: boolean;
  ...
  export interface PalletCommitteeCall extends Enum {
    ...
    readonly asVoteOrPropose: {
      ...
      readonly call: PolymeshRuntimeCiRuntimeCall;
    } & Struct;
  ...
  export interface PalletMultisigCall extends Enum {
    ...
    readonly asCreateOrApproveProposalAsIdentity: {
      ...
      readonly proposal: PolymeshRuntimeCiRuntimeCall;
      readonly expiry: Option<u64>;
  ...
  /** @name PalletStakingRewardDestination (367) */
  ...
  /** @name PalletStakingValidatorPrefs (368) */
  export interface PalletStakingValidatorPrefs extends Struct {
    readonly commission: Compact<Perbill>;
    readonly blocked: bool;
  }

  /** @name PalletStakingCompactAssignments (374) */
  ...
  /** @name PolymeshRuntimeCiRuntimeSessionKeys (428) */
  ...
  /** @name SpFinalityGrandpaEquivocationProof (431) */
  export interface SpFinalityGrandpaEquivocationProof extends Struct {
    readonly setId: u64;
    readonly equivocation: SpFinalityGrandpaEquivocation;
  }

  /** @name SpFinalityGrandpaEquivocation (432) */
  ...
  /** @name FinalityGrandpaEquivocationPrevote (433) */
  ...
  /** @name FinalityGrandpaPrecommit (439) */
  export interface FinalityGrandpaPrecommit extends Struct {
    readonly targetHash: H256;
    readonly targetNumber: u32;
  }

  /** @name PalletImOnlineCall (441) */
  ...
  /** @name PalletImOnlineHeartbeat (442) */
  ...
  export interface PalletAssetCall extends Enum {
    ...
    readonly type: 'RegisterTicker' | 'AcceptTickerTransfer' | 'AcceptAssetOwnershipTransfer' | 'CreateAsset' | 'Freeze' | 'Unfreeze' | 'RenameAsset' | 'Issue' | 'Redeem' | 'MakeDivisible' | 'AddDocuments' | 'RemoveDocuments' | 'SetFundingRound' | 'UpdateIdentifiers' | 'ClaimClassicTicker' | 'ReserveClassicTicker' | 'ControllerTransfer' | 'RegisterCustomAssetType';
  }

  /** @name PolymeshPrimitivesEthereumEcdsaSignature (453) */
  export interface PolymeshPrimitivesEthereumEcdsaSignature extends U8aFixed {}

  /** @name PalletAssetClassicTickerImport (455) */
  ...
  /** @name PalletAssetTickerRegistrationConfig (456) */
  ...
  /** @name PalletCorporateActionsDistributionCall (457) */
  ...
  /** @name PalletAssetCheckpointCall (459) */
  ...
  /** @name PalletAssetCheckpointScheduleSpec (460) */
  ...
  /** @name PalletComplianceManagerCall (461) */
  ...
  /** @name PalletCorporateActionsCall (462) */
  ...
  /** @name PalletCorporateActionsRecordDateSpec (464) */
  ...
  /** @name PalletCorporateActionsBallotCall (467) */
  ...
  /** @name PalletPipsSnapshotResult (471) */
  ...
  /** @name PalletPortfolioMovePortfolioItem (474) */
  ...
  /** @name PalletProtocolFeeCall (475) */
  ...
  /** @name PolymeshCommonUtilitiesProtocolFeeProtocolOp (476) */
  ...
  /** @name PalletSettlementReceiptDetails (481) */
  ...
  /** @name SpRuntimeMultiSignature (482) */
  ...
  /** @name SpCoreEcdsaSignature (483) */
  export interface SpCoreEcdsaSignature extends U8aFixed {}

  /** @name PalletStatisticsCall (484) */
  ...
  /** @name PalletStoPriceTier (487) */
  export interface PalletStoPriceTier extends Struct {
    readonly total: u128;
    readonly price: u128;
  }

  /** @name PalletTreasuryCall (490) */
  ...
  /** @name PolymeshPrimitivesBeneficiary (492) */
  export interface PolymeshPrimitivesBeneficiary extends Struct {
    readonly id: PolymeshPrimitivesIdentityId;
    readonly amount: u128;
  }

  /** @name PalletUtilityCall (493) */
  export interface PalletUtilityCall extends Enum {
    readonly isBatch: boolean;
    readonly asBatch: {
      readonly calls: Vec<PolymeshRuntimeCiRuntimeCall>;
    } & Struct;
  ...
  /** @name PalletUtilityUniqueCall (495) */
  export interface PalletUtilityUniqueCall extends Struct {
    readonly nonce: u64;
    readonly call: PolymeshRuntimeCiRuntimeCall;
  }

  /** @name PalletBaseCall (496) */
  export type PalletBaseCall = Null;

  /** @name PalletExternalAgentsCall (497) */
  ...
  /** @name PalletRewardsItnRewardStatus (500) */
  ...
  /** @name PalletCommitteePolymeshVotes (502) */
  ...
  /** @name PalletMultisigProposalDetails (514) */
  ...
  /** @name PalletMultisigProposalStatus (515) */
  ...
  /** @name PalletBridgeBridgeTxDetail (518) */
  ...
  /** @name PalletBridgeBridgeTxStatus (519) */
  ...
  /** @name PalletStakingStakingLedger (523) */
  ...
  /** @name PalletStakingUnlockChunk (525) */
  export interface PalletStakingUnlockChunk extends Struct {
    readonly value: Compact<u128>;
    readonly era: Compact<u32>;
  }

  /** @name PalletStakingNominations (526) */
  ...
  /** @name PalletStakingUnappliedSlash (534) */
  ...
  /** @name PalletStakingSlashingSlashingSpans (538) */
  ...
  /** @name PalletStakingSlashingSpanRecord (539) */
  export interface PalletStakingSlashingSpanRecord extends Struct {
    readonly slashed: u128;
    readonly paidOut: u128;
  }

  /** @name PalletStakingElectionResult (540) */
  ...
  /** @name PalletStakingElectionStatus (541) */
  ...
  /** @name PalletStakingPermissionedIdentityPrefs (542) */
  ...
  /** @name PalletStakingReleases (543) */
  ...
  /** @name SpStakingOffenceOffenceDetails (545) */
  ...
  /** @name PalletGrandpaStoredState (552) */
  ...
  /** @name PalletGrandpaStoredPendingChange (553) */
  ...
  /** @name PalletAssetAssetOwnershipRelation (570) */
  ...
  /** @name PalletAssetClassicTickerRegistration (572) */
  export interface PalletAssetClassicTickerRegistration extends Struct {
    readonly ethOwner: PolymeshPrimitivesEthereumEthereumAddress;
    readonly isCreated: bool;
  }

  /** @name PalletAssetError (575) */
  ...
  /** @name PalletCorporateActionsDistributionError (578) */
  ...
  /** @name PalletAssetCheckpointError (585) */
  ...
  /** @name PolymeshPrimitivesComplianceManagerAssetCompliance (586) */
  ...
  /** @name PalletComplianceManagerError (588) */
  ...
  /** @name PalletCorporateActionsError (591) */
  ...
  /** @name PalletCorporateActionsBallotError (593) */
  ...
  /** @name PalletPermissionsError (594) */
  ...
  /** @name PalletPipsPipsMetadata (595) */
  ...
  /** @name PalletPipsVotingResult (599) */
  ...
  /** @name PalletPipsVote (600) */
  export interface PalletPipsVote extends ITuple<[bool, u128]> {}

  /** @name PalletPipsSnapshotMetadata (601) */
  ...
  /** @name PalletProtocolFeeError (610) */
  ...
  /** @name PalletSchedulerScheduledV2 (613) */
  ...
  /** @name PolymeshRuntimeCiRuntimeOriginCaller (614) */
  ...
  /** @name PalletSchedulerReleases (620) */
  ...
  /** @name PalletSettlementInstructionStatus (626) */
  ...
  /** @name PalletSettlementLegStatus (628) */
  ...
  /** @name PalletSettlementAffirmationStatus (630) */
  ...
  /** @name PalletSettlementError (634) */
  ...
  /** @name PalletStatisticsError (638) */
  ...
  /** @name PalletExternalAgentsError (645) */
  ...
  /** @name PalletRelayerSubsidy (646) */
  export interface PalletRelayerSubsidy extends Struct {
    readonly payingKey: AccountId32;
    readonly remaining: u128;
  }

  /** @name PalletRelayerError (647) */
  ...
  /** @name PolymeshExtensionsCheckWeight (658) */
  ...
  /** @name PalletTransactionPaymentChargeTransactionPayment (660) */
  export interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name PalletPermissionsStoreCallMetadata (661) */
  export type PalletPermissionsStoreCallMetadata = Null;

  /** @name PolymeshRuntimeCiRuntime (662) */
