...
declare module '@polkadot/types/lookup' {
  ...
  /** @name SchnorrkelSignSignature (336) */
  ...
  /** @name Curve25519DalekRistrettoCompressedRistretto (337) */
  export interface Curve25519DalekRistrettoCompressedRistretto extends U8aFixed {}

  /** @name Curve25519DalekScalar (338) */
  ...
  /** @name ConfidentialIdentitySignSignature (340) */
  export interface ConfidentialIdentitySignSignature extends Struct {
    readonly r: Curve25519DalekRistrettoCompressedRistretto;
    readonly s: Curve25519DalekScalar;
  }

  /** @name ConfidentialIdentityClaimProofsZkProofData (341) */
  ...
  /** @name Curve25519DalekBackendSerialU64FieldFieldElement51 (345) */
  ...
  /** @name PolymeshCommonUtilitiesGroupInactiveMember (349) */
  ...
  /** @name PalletStakingRewardDestination (365) */
  ...
  /** @name PalletStakingValidatorPrefs (366) */
  export interface PalletStakingValidatorPrefs extends Struct {
    readonly commission: Compact<Perbill>;
    readonly blocked: bool;
  }

  /** @name PalletStakingCompactAssignments (372) */
  ...
  /** @name PolymeshRuntimeDevelopRuntimeSessionKeys (426) */
  ...
  /** @name SpAuthorityDiscoveryAppPublic (427) */
  ...
  /** @name SpFinalityGrandpaEquivocationProof (429) */
  export interface SpFinalityGrandpaEquivocationProof extends Struct {
    readonly setId: u64;
    readonly equivocation: SpFinalityGrandpaEquivocation;
  }

  /** @name SpFinalityGrandpaEquivocation (430) */
  ...
  /** @name SpFinalityGrandpaAppSignature (433) */
  ...
  /** @name SpCoreOffchainOpaqueNetworkState (441) */
  export interface SpCoreOffchainOpaqueNetworkState extends Struct {
    readonly peerId: Bytes;
    readonly externalAddresses: Vec<Bytes>;
  }

  /** @name PalletImOnlineSr25519AppSr25519Signature (445) */
  ...
  /** @name PolymeshPrimitivesEthereumEcdsaSignature (451) */
  export interface PolymeshPrimitivesEthereumEcdsaSignature extends U8aFixed {}

  /** @name PalletAssetClassicTickerImport (453) */
  ...
  /** @name PalletAssetTickerRegistrationConfig (454) */
  ...
  /** @name PalletCorporateActionsDistributionCall (455) */
  ...
  /** @name PalletAssetCheckpointCall (457) */
  ...
  /** @name PalletAssetCheckpointScheduleSpec (458) */
  ...
  /** @name PalletComplianceManagerCall (459) */
  ...
  /** @name PalletCorporateActionsCall (460) */
  ...
  /** @name PalletCorporateActionsRecordDateSpec (462) */
  ...
  /** @name PalletCorporateActionsBallotCall (465) */
  ...
  /** @name PalletPipsSnapshotResult (469) */
  ...
  /** @name PalletPortfolioMovePortfolioItem (472) */
  ...
  /** @name PalletProtocolFeeCall (473) */
  ...
  /** @name PolymeshCommonUtilitiesProtocolFeeProtocolOp (474) */
  ...
  /** @name PalletSettlementReceiptDetails (479) */
  ...
  /** @name PalletStoPriceTier (485) */
  export interface PalletStoPriceTier extends Struct {
    readonly total: u128;
    readonly price: u128;
  }

  /** @name PalletTreasuryCall (488) */
  ...
  /** @name PolymeshPrimitivesBeneficiary (490) */
  export interface PolymeshPrimitivesBeneficiary extends Struct {
    readonly id: PolymeshPrimitivesIdentityId;
    readonly amount: u128;
  }

  /** @name PalletUtilityCall (491) */
  ...
  /** @name PalletRewardsItnRewardStatus (498) */
  ...
  /** @name PalletCommitteePolymeshVotes (500) */
  ...
  /** @name PalletMultisigProposalStatus (513) */
  ...
  /** @name PalletBridgeBridgeTxDetail (516) */
  ...
  /** @name PalletBridgeBridgeTxStatus (517) */
  ...
  /** @name PalletStakingStakingLedger (521) */
  ...
  /** @name PalletStakingUnlockChunk (523) */
  export interface PalletStakingUnlockChunk extends Struct {
    readonly value: Compact<u128>;
    readonly era: Compact<u32>;
  }

  /** @name PalletStakingNominations (524) */
  ...
  /** @name PalletStakingUnappliedSlash (532) */
  ...
  /** @name PalletStakingSlashingSlashingSpans (536) */
  ...
  /** @name PalletStakingSlashingSpanRecord (537) */
  export interface PalletStakingSlashingSpanRecord extends Struct {
    readonly slashed: u128;
    readonly paidOut: u128;
  }

  /** @name PalletStakingElectionResult (538) */
  ...
  /** @name PalletStakingElectionStatus (539) */
  ...
  /** @name PalletStakingPermissionedIdentityPrefs (540) */
  ...
  /** @name PalletStakingReleases (541) */
  ...
  /** @name SpStakingOffenceOffenceDetails (543) */
  export interface SpStakingOffenceOffenceDetails extends Struct {
    readonly offender: ITuple<[AccountId32, PalletStakingExposure]>;
    readonly reporters: Vec<AccountId32>;
  }

  /** @name SpCoreCryptoKeyTypeId (548) */
  export interface SpCoreCryptoKeyTypeId extends U8aFixed {}

  /** @name PalletSessionError (549) */
  ...
  /** @name PalletGrandpaStoredState (550) */
  ...
  /** @name PalletGrandpaStoredPendingChange (551) */
  ...
  /** @name PalletAssetAssetOwnershipRelation (568) */
  ...
  /** @name PalletAssetClassicTickerRegistration (570) */
  export interface PalletAssetClassicTickerRegistration extends Struct {
    readonly ethOwner: PolymeshPrimitivesEthereumEthereumAddress;
    readonly isCreated: bool;
  }

  /** @name PalletAssetError (573) */
  ...
  /** @name PalletCorporateActionsDistributionError (576) */
  ...
  /** @name PalletAssetCheckpointError (583) */
  ...
  /** @name PolymeshPrimitivesComplianceManagerAssetCompliance (584) */
  ...
  /** @name PalletComplianceManagerError (586) */
  ...
  /** @name PalletCorporateActionsError (589) */
  ...
  /** @name PalletCorporateActionsBallotError (591) */
  ...
  /** @name PalletPermissionsError (592) */
  ...
  /** @name PalletPipsPipsMetadata (593) */
  ...
  /** @name PalletPipsDepositInfo (595) */
  ...
  /** @name PalletPipsVotingResult (597) */
  ...
  /** @name PalletPipsVote (598) */
  export interface PalletPipsVote extends ITuple<[bool, u128]> {}

  /** @name PalletPipsSnapshotMetadata (599) */
  ...
  /** @name PalletProtocolFeeError (608) */
  ...
  /** @name PolymeshRuntimeDevelopRuntimeOriginCaller (612) */
  ...
  /** @name PalletSchedulerReleases (618) */
  ...
  /** @name PalletSettlementInstructionStatus (624) */
  ...
  /** @name PalletSettlementLegStatus (626) */
  ...
  /** @name PalletSettlementAffirmationStatus (628) */
  ...
  /** @name PalletSettlementError (632) */
  ...
  /** @name PalletStatisticsError (636) */
  ...
  /** @name PalletExternalAgentsError (643) */
  ...
  /** @name PalletRelayerSubsidy (644) */
  export interface PalletRelayerSubsidy extends Struct {
    readonly payingKey: AccountId32;
    readonly remaining: u128;
  }

  /** @name PalletRelayerError (645) */
  ...
  /** @name PalletTestUtilsError (647) */
  export type PalletTestUtilsError = Null;

  /** @name FrameSystemExtensionsCheckSpecVersion (650) */
  export type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (651) */
  export type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (652) */
  export type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (655) */
  export interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name PolymeshExtensionsCheckWeight (656) */
  export interface PolymeshExtensionsCheckWeight extends FrameSystemExtensionsCheckWeight {}

  /** @name FrameSystemExtensionsCheckWeight (657) */
  export type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (658) */
  export interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name PalletPermissionsStoreCallMetadata (659) */
  export type PalletPermissionsStoreCallMetadata = Null;

  /** @name PolymeshRuntimeDevelopRuntime (660) */
