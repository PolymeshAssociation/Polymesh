...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    checkpoint: {
       ...
       **/
      cachedNextCheckpoints: AugmentedQuery<ApiType, (arg: PolymeshPrimitivesAssetAssetId | string | Uint8Array) => Observable<Option<PolymeshPrimitivesCheckpointNextCheckpoints>>, [PolymeshPrimitivesAssetAssetId]> & QueryableStorageEntry<ApiType, [PolymeshPrimitivesAssetAssetId]>;
      /**
       ...
       **/
      scheduledCheckpoints: AugmentedQuery<ApiType, (arg1: PolymeshPrimitivesAssetAssetId | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Option<PolymeshPrimitivesCheckpointScheduleCheckpoints>>, [PolymeshPrimitivesAssetAssetId, u64]> & QueryableStorageEntry<ApiType, [PolymeshPrimitivesAssetAssetId, u64]>;
      /**
    ...
    multiSig: {
       ...
       **/
      lastInvalidProposal: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<u64>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
    ...
    permissions: {
       ...
       **/
      currentDispatchableName: AugmentedQuery<ApiType, () => Observable<Text>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * The name of the current pallet (aka module name).
       **/
      currentPalletName: AugmentedQuery<ApiType, () => Observable<Text>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    pips: {
       ...
       **/
      pendingPipExpiry: AugmentedQuery<ApiType, () => Observable<PolymeshPrimitivesMaybeBlock>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * All PIPs that still require refunds.
       **/
      pendingRefunds: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<bool>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      votesToBePruned: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<bool>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    polymeshCommittee: {
       ...
       **/
      expiresAfter: AugmentedQuery<ApiType, () => Observable<PolymeshPrimitivesMaybeBlock>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    protocolFee: {
       ...
       **/
      baseFees: AugmentedQuery<ApiType, (arg: PolymeshPrimitivesProtocolFeeProtocolOp | 'AssetRegisterTicker' | 'AssetIssue' | 'AssetAddDocuments' | 'AssetCreateAsset' | 'CheckpointCreateSchedule' | 'ComplianceManagerAddComplianceRequirement' | 'IdentityCddRegisterDid' | 'IdentityAddClaim' | 'IdentityAddSecondaryKeysWithAuthorization' | 'PipsPropose' | 'ContractsPutCode' | 'CorporateBallotAttachBallot' | 'CapitalDistributionDistribute' | 'NFTCreateCollection' | 'NFTMint' | 'IdentityCreateChildIdentity' | number | Uint8Array) => Observable<u128>, [PolymeshPrimitivesProtocolFeeProtocolOp]> & QueryableStorageEntry<ApiType, [PolymeshPrimitivesProtocolFeeProtocolOp]>;
      /**
    ...
    relayer: {
       ...
       **/
      pendingSubsidies: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<u128>>, [AccountId32, AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32, AccountId32]>;
      /**
       * Nonce for `relay_tx`.
       **/
      relayTxNonces: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<u64>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
    ...
    settlement: {
       ...
       **/
      affirmsReceived: AugmentedQuery<ApiType, (arg1: u64 | AnyNumber | Uint8Array, arg2: PolymeshPrimitivesAssetAssetHolder | { Portfolio: any } | { Account: any } | string | Uint8Array) => Observable<PolymeshPrimitivesSettlementAffirmationStatus>, [u64, PolymeshPrimitivesAssetAssetHolder]> & QueryableStorageEntry<ApiType, [u64, PolymeshPrimitivesAssetAssetHolder]>;
      /**
       ...
       **/
      lockedTimestamp: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<u64>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
    ...
    sto: {
       ...
       **/
      fundraiserOffchainAsset: AugmentedQuery<ApiType, (arg1: PolymeshPrimitivesAssetAssetId | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Option<PolymeshPrimitivesTicker>>, [PolymeshPrimitivesAssetAssetId, u64]> & QueryableStorageEntry<ApiType, [PolymeshPrimitivesAssetAssetId, u64]>;
      /**
    ...
    validators: {
       ...
       **/
      permissionedIdentity: AugmentedQuery<ApiType, (arg: PolymeshPrimitivesIdentityId | string | Uint8Array) => Observable<Option<PalletValidatorsPermissionedIdentityPrefs>>, [PolymeshPrimitivesIdentityId]> & QueryableStorageEntry<ApiType, [PolymeshPrimitivesIdentityId]>;
      /**
       * Slashing switch for validators & Nominators.
       **/
      slashingAllowedFor: AugmentedQuery<ApiType, () => Observable<PalletValidatorsSlashingSwitch>, []> & QueryableStorageEntry<ApiType, []>;
      /**
