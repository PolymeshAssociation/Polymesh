...
export default {
  ...
  /**
   * Lookup325: polymesh_primitives::identity::Identity<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup327: polymesh_primitives::secondary_key::SecondaryKey<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup329: pallet_identity::types::Claim1stKey
   **/
  ...
  /**
   * Lookup330: pallet_identity::types::Claim2ndKey
   **/
  ...
  /**
   * Lookup337: polymesh_primitives::secondary_key::api::LegacyPermissions
   **/
  ...
  /**
   * Lookup338: polymesh_primitives::secondary_key::api::LegacyExtrinsicPermissions
   **/
  ...
  /**
   * Lookup341: polymesh_primitives::secondary_key::api::LegacyPalletPermissions
   **/
  ...
  /**
   * Lookup343: polymesh_common_utilities::traits::identity::SecondaryKeyWithAuth<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup345: polymesh_primitives::investor_zkproof_data::v1::InvestorZKProofData
   **/
  PolymeshPrimitivesInvestorZkproofDataV1InvestorZKProofData: 'SchnorrkelSignSignature',
  /**
   * Lookup346: schnorrkel::sign::Signature
   **/
  ...
  /**
   * Lookup347: curve25519_dalek::ristretto::CompressedRistretto
   **/
  Curve25519DalekRistrettoCompressedRistretto: '[u8;32]',
  /**
   * Lookup348: curve25519_dalek::scalar::Scalar
   **/
  Curve25519DalekScalar: {
    bytes: '[u8;32]'
  },
  /**
   * Lookup349: confidential_identity::claim_proofs::ScopeClaimProof
   **/
  ...
  /**
   * Lookup350: confidential_identity::sign::Signature
   **/
  ...
  /**
   * Lookup355: curve25519_dalek::backend::serial::u64::field::FieldElement51
   **/
  Curve25519DalekBackendSerialU64FieldFieldElement51: '[u64;5]',
  /**
   * Lookup357: pallet_identity::Error<T>
   **/
  PalletIdentityError: {
  ...
  /**
   * Lookup359: polymesh_common_utilities::traits::group::InactiveMember<Moment>
   **/
  ...
  /**
   * Lookup360: pallet_group::Call<T, I>
   **/
  PalletGroupCall: {
    _enum: {
  ...
  /**
   * Lookup361: pallet_group::Error<T, I>
   **/
  PalletGroupError: {
  ...
  /**
   * Lookup363: pallet_committee::Call<T, I>
   **/
  PalletCommitteeCall: {
    _enum: {
      set_vote_threshold: {
  ...
  /**
   * Lookup369: pallet_multisig::Call<T>
   **/
  PalletMultisigCall: {
    _enum: {
      create_multisig: {
  ...
  /**
   * Lookup370: pallet_bridge::Call<T>
   **/
  PalletBridgeCall: {
    _enum: {
      change_controller: {
  ...
  /**
   * Lookup374: pallet_staking::Call<T>
   **/
  PalletStakingCall: {
    _enum: {
      bond: {
  ...
  /**
   * Lookup375: pallet_staking::RewardDestination<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup376: pallet_staking::ValidatorPrefs
   **/
  ...
  /**
   * Lookup382: pallet_staking::CompactAssignments
   **/
  ...
  /**
   * Lookup434: pallet_staking::ElectionSize
   **/
  ...
  /**
   * Lookup435: pallet_session::pallet::Call<T>
   **/
  PalletSessionCall: {
    _enum: {
      set_keys: {
  ...
  /**
   * Lookup436: polymesh_runtime_develop::runtime::SessionKeys
   **/
  ...
  /**
   * Lookup437: sp_authority_discovery::app::Public
   **/
  SpAuthorityDiscoveryAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup438: pallet_grandpa::pallet::Call<T>
   **/
  PalletGrandpaCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup439: sp_finality_grandpa::EquivocationProof<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup440: sp_finality_grandpa::Equivocation<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup441: finality_grandpa::Equivocation<sp_finality_grandpa::app::Public, finality_grandpa::Prevote<primitive_types::H256, N>, sp_finality_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup442: finality_grandpa::Prevote<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup443: sp_finality_grandpa::app::Signature
   **/
  ...
  /**
   * Lookup446: finality_grandpa::Equivocation<sp_finality_grandpa::app::Public, finality_grandpa::Precommit<primitive_types::H256, N>, sp_finality_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup447: finality_grandpa::Precommit<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup449: pallet_im_online::pallet::Call<T>
   **/
  PalletImOnlineCall: {
    _enum: {
      heartbeat: {
  ...
  /**
   * Lookup450: pallet_im_online::Heartbeat<BlockNumber>
   **/
  ...
  /**
   * Lookup451: sp_core::offchain::OpaqueNetworkState
   **/
  ...
  /**
   * Lookup455: pallet_im_online::sr25519::app_sr25519::Signature
   **/
  ...
  /**
   * Lookup461: polymesh_primitives::ethereum::EcdsaSignature
   **/
  PolymeshPrimitivesEthereumEcdsaSignature: '[u8;65]',
  /**
   * Lookup463: pallet_asset::ClassicTickerImport
   **/
  ...
  /**
   * Lookup464: pallet_asset::TickerRegistrationConfig<U>
   **/
  ...
  /**
   * Lookup465: polymesh_primitives::asset_metadata::AssetMetadataKey
   **/
  ...
  /**
   * Lookup466: pallet_corporate_actions::distribution::Call<T>
   **/
  ...
  /**
   * Lookup468: pallet_asset::checkpoint::Call<T>
   **/
  ...
  /**
   * Lookup469: pallet_asset::checkpoint::ScheduleSpec
   **/
  ...
  /**
   * Lookup470: pallet_compliance_manager::Call<T>
   **/
  ...
  /**
   * Lookup471: pallet_corporate_actions::Call<T>
   **/
  ...
  /**
   * Lookup473: pallet_corporate_actions::RecordDateSpec
   **/
  ...
  /**
   * Lookup476: pallet_corporate_actions::ballot::Call<T>
   **/
  ...
  /**
   * Lookup480: pallet_pips::SnapshotResult
   **/
  PalletPipsSnapshotResult: {
    _enum: ['Approve', 'Reject', 'Skip']
  },
  /**
   * Lookup481: pallet_portfolio::Call<T>
   **/
  PalletPortfolioCall: {
    _enum: {
      create_portfolio: {
  ...
  /**
   * Lookup483: pallet_portfolio::MovePortfolioItem
   **/
  ...
  /**
   * Lookup484: pallet_protocol_fee::Call<T>
   **/
  ...
  /**
   * Lookup485: polymesh_common_utilities::protocol_fee::ProtocolOp
   **/
  ...
  /**
   * Lookup486: pallet_scheduler::pallet::Call<T>
   **/
  PalletSchedulerCall: {
    _enum: {
      schedule: {
  ...
  /**
   * Lookup488: pallet_settlement::Call<T>
   **/
  ...
  /**
   * Lookup490: pallet_settlement::ReceiptDetails<sp_core::crypto::AccountId32, sp_runtime::MultiSignature>
   **/
  ...
  /**
   * Lookup492: sp_core::ecdsa::Signature
   **/
  SpCoreEcdsaSignature: '[u8;65]',
  /**
   * Lookup493: pallet_statistics::Call<T>
   **/
  ...
  /**
   * Lookup496: pallet_sto::PriceTier
   **/
  PalletStoPriceTier: {
    total: 'u128',
    price: 'u128'
  ...
  /**
   * Lookup499: pallet_treasury::Call<T>
   **/
  PalletTreasuryCall: {
    _enum: {
      disbursement: {
  ...
  /**
   * Lookup501: polymesh_primitives::Beneficiary<Balance>
   **/
  ...
  /**
   * Lookup502: pallet_utility::Call<T>
   **/
  PalletUtilityCall: {
    _enum: {
      batch: {
  ...
  /**
   * Lookup504: pallet_utility::UniqueCall<polymesh_runtime_develop::runtime::Call>
   **/
  ...
  /**
   * Lookup505: pallet_base::Call<T>
   **/
  PalletBaseCall: 'Null',
  /**
   * Lookup506: pallet_external_agents::Call<T>
   **/
  ...
  /**
   * Lookup507: pallet_relayer::Call<T>
   **/
  PalletRelayerCall: {
    _enum: {
      set_paying_key: {
  ...
  /**
   * Lookup508: pallet_rewards::Call<T>
   **/
  PalletRewardsCall: {
    _enum: {
      claim_itn_reward: {
  ...
  /**
   * Lookup509: pallet_rewards::ItnRewardStatus
   **/
  ...
  /**
   * Lookup510: pallet_test_utils::Call<T>
   **/
  PalletTestUtilsCall: {
    _enum: {
      register_did: {
  ...
  /**
   * Lookup511: pallet_committee::PolymeshVotes<BlockNumber>
   **/
  ...
  /**
   * Lookup513: pallet_committee::Error<T, I>
   **/
  ...
  /**
   * Lookup523: pallet_multisig::ProposalDetails<T>
   **/
  ...
  /**
   * Lookup527: pallet_bridge::BridgeTxDetail<BlockNumber>
   **/
  ...
  /**
   * Lookup528: pallet_bridge::BridgeTxStatus
   **/
  ...
  /**
   * Lookup531: pallet_bridge::Error<T>
   **/
  PalletBridgeError: {
  ...
  /**
   * Lookup532: pallet_staking::StakingLedger<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup534: pallet_staking::UnlockChunk<Balance>
   **/
  ...
  /**
   * Lookup535: pallet_staking::Nominations<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup536: pallet_staking::ActiveEraInfo
   **/
  ...
  /**
   * Lookup541: pallet_staking::Forcing
   **/
  ...
  /**
   * Lookup549: pallet_staking::ElectionResult<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup550: pallet_staking::ElectionStatus<BlockNumber>
   **/
  ...
  /**
   * Lookup551: pallet_staking::PermissionedIdentityPrefs
   **/
  ...
  /**
   * Lookup554: sp_staking::offence::OffenceDetails<sp_core::crypto::AccountId32, Offender>
   **/
  ...
  /**
   * Lookup561: pallet_grandpa::StoredState<N>
   **/
  ...
  /**
   * Lookup562: pallet_grandpa::StoredPendingChange<N, Limit>
   **/
  ...
  /**
   * Lookup564: pallet_grandpa::pallet::Error<T>
   **/
  PalletGrandpaError: {
  ...
  /**
   * Lookup573: pallet_sudo::Error<T>
   **/
  PalletSudoError: {
    _enum: ['RequireSudo']
  },
  /**
   * Lookup574: pallet_asset::TickerRegistration<U>
   **/
  ...
  /**
   * Lookup575: pallet_asset::SecurityToken
   **/
  ...
  /**
   * Lookup579: pallet_asset::AssetOwnershipRelation
   **/
  PalletAssetAssetOwnershipRelation: {
    _enum: ['NotOwned', 'TickerOwned', 'AssetOwned']
  },
  /**
   * Lookup581: pallet_asset::ClassicTickerRegistration
   **/
  ...
  /**
   * Lookup587: pallet_asset::Error<T>
   **/
  PalletAssetError: {
  ...
  /**
   * Lookup590: pallet_corporate_actions::distribution::Error<T>
   **/
  ...
  /**
   * Lookup597: pallet_asset::checkpoint::Error<T>
   **/
  ...
  /**
   * Lookup598: polymesh_primitives::compliance_manager::AssetCompliance
   **/
  ...
  /**
   * Lookup600: pallet_compliance_manager::Error<T>
   **/
  ...
  /**
   * Lookup603: pallet_corporate_actions::Error<T>
   **/
  ...
  /**
   * Lookup605: pallet_corporate_actions::ballot::Error<T>
   **/
  ...
  /**
   * Lookup606: pallet_permissions::Error<T>
   **/
  PalletPermissionsError: {
    _enum: ['UnauthorizedCaller']
  },
  /**
   * Lookup607: pallet_pips::PipsMetadata<BlockNumber>
   **/
  ...
  /**
   * Lookup609: pallet_pips::DepositInfo<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup610: pallet_pips::Pip<polymesh_runtime_develop::runtime::Call, sp_core::crypto::AccountId32>
   **/
  PalletPipsPip: {
    id: 'u32',
    proposal: 'Call',
  ...
  /**
   * Lookup611: pallet_pips::VotingResult
   **/
  ...
  /**
   * Lookup612: pallet_pips::Vote
   **/
  PalletPipsVote: '(bool,u128)',
  /**
   * Lookup613: pallet_pips::SnapshotMetadata<BlockNumber, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup621: pallet_portfolio::Error<T>
   **/
  ...
  /**
   * Lookup622: pallet_protocol_fee::Error<T>
   **/
  PalletProtocolFeeError: {
    _enum: ['InsufficientAccountBalance', 'UnHandledImbalances', 'InsufficientSubsidyBalance']
  },
  /**
   * Lookup625: pallet_scheduler::ScheduledV2<polymesh_runtime_develop::runtime::Call, BlockNumber, polymesh_runtime_develop::runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup626: polymesh_runtime_develop::runtime::OriginCaller
   **/
  ...
  /**
   * Lookup627: frame_system::RawOrigin<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup628: pallet_committee::RawOrigin<sp_core::crypto::AccountId32, pallet_committee::Instance1>
   **/
  PalletCommitteeRawOriginInstance1: {
    _enum: ['Endorsed']
  },
  /**
   * Lookup629: pallet_committee::RawOrigin<sp_core::crypto::AccountId32, pallet_committee::Instance3>
   **/
  PalletCommitteeRawOriginInstance3: {
    _enum: ['Endorsed']
  },
  /**
   * Lookup630: pallet_committee::RawOrigin<sp_core::crypto::AccountId32, pallet_committee::Instance4>
   **/
  PalletCommitteeRawOriginInstance4: {
    _enum: ['Endorsed']
  },
  /**
   * Lookup631: sp_core::Void
   **/
  SpCoreVoid: 'Null',
  /**
   * Lookup632: pallet_scheduler::Releases
   **/
  PalletSchedulerReleases: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup633: pallet_scheduler::pallet::Error<T>
   **/
  PalletSchedulerError: {
    _enum: ['FailedToSchedule', 'NotFound', 'TargetBlockNumberInPast', 'RescheduleNoChange']
  },
  /**
   * Lookup634: pallet_settlement::Venue
   **/
  ...
  /**
   * Lookup637: pallet_settlement::Instruction<Moment, BlockNumber>
   **/
  ...
  /**
   * Lookup638: pallet_settlement::InstructionStatus
   **/
  PalletSettlementInstructionStatus: {
    _enum: ['Unknown', 'Pending', 'Failed']
  },
  /**
   * Lookup640: pallet_settlement::LegStatus<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup642: pallet_settlement::AffirmationStatus
   **/
  PalletSettlementAffirmationStatus: {
    _enum: ['Unknown', 'Pending', 'Affirmed']
  },
  /**
   * Lookup646: pallet_settlement::Error<T>
   **/
  ...
  /**
   * Lookup653: pallet_treasury::Error<T>
   **/
  PalletTreasuryError: {
    _enum: ['InsufficientBalance']
  },
  /**
   * Lookup654: pallet_utility::Error<T>
   **/
  PalletUtilityError: {
    _enum: ['InvalidSignature', 'TargetCddMissing', 'InvalidNonce']
  },
  /**
   * Lookup655: pallet_base::Error<T>
   **/
  PalletBaseError: {
    _enum: ['TooLong', 'CounterOverflow']
  },
  /**
   * Lookup657: pallet_external_agents::Error<T>
   **/
  ...
  /**
   * Lookup658: pallet_relayer::Subsidy<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup659: pallet_relayer::Error<T>
   **/
  PalletRelayerError: {
  ...
  /**
   * Lookup670: polymesh_extensions::check_weight::CheckWeight<T>
   **/
  ...
  /**
   * Lookup673: pallet_permissions::StoreCallMetadata<T>
   **/
  PalletPermissionsStoreCallMetadata: 'Null',
  /**
   * Lookup674: polymesh_runtime_develop::runtime::Runtime
   **/
