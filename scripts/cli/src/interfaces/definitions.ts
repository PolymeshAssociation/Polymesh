export default {
	types: {
		...
		ValidatorPrefsWithBlocked: { commission: "Compact<Perbill>" },
		IdentityId: "[u8; 32]",
		EventDid: "IdentityId",
		EventCounts: "Vec<u32>",
		...
		AssetPermissions: {
			_enum: { Whole: "", These: "Vec<Ticker>", Except: "Vec<Ticker>" },
		},
		...
		Scope: {
			_enum: { Identity: "IdentityId", Ticker: "Ticker", Custom: "Vec<u8>" },
		},
		...
		IdentityClaimKey: { id: "IdentityId", claim_type: "ClaimType" },
		...
		MaybeBlock: { _enum: { Some: "BlockNumber", None: "" } },
		Url: "Text",
		PipDescription: "Text",
		PipsMetadata: {
			id: "PipId",
		...
		Committee: { _enum: { Technical: "", Upgrade: "" } },
		SkippedCount: "u8",
		...
		SnapshotResult: { _enum: { Approve: "", Reject: "", Skip: "" } },
		...
		OffChainSignature: {
			_enum: { Ed25519: "H512", Sr25519: "H512", Ecdsa: "H512" },
		},
		Authorization: {
		...
		ProportionMatch: { _enum: ["AtLeast", "MoreThan"] },
		...
		Memo: "[u8;32]",
		IssueRecipient: { _enum: { Account: "AccountId", Identity: "IdentityId" } },
		BridgeTx: {
			nonce: "u32",
			recipient: "AccountId",
			value: "Balance",
		...
		PendingTx: { did: "IdentityId", bridge_tx: "BridgeTx" },
		AssetCompliance: {
			is_paused: "bool",
		...
		BatchRevokeClaimItem: { target: "IdentityId", claim: "Claim" },
		InactiveMember: {
			id: "IdentityId",
		...
		DidRecords: {
			_enum: { Success: "DidRecordsSuccess", IdNotFound: "Vec<u8>" },
		},
		...
		HandledTxStatus: { _enum: { Success: "", Error: "Text" } },
		CappedFee: "u64",
		...
		PortfolioName: "Text",
		PortfolioNumber: "u64",
		PortfolioKind: { _enum: { Default: "", User: "PortfolioNumber" } },
		PortfolioId: { did: "IdentityId", kind: "PortfolioKind" },
		ProverTickerKey: { prover: "IdentityId", ticker: "Ticker" },
		TickerRangeProof: {
		...
		InstructionStatus: { _enum: { Unknown: "", Pending: "", Failed: "" } },
		LegStatus: {
			_enum: {
				PendingTokenLock: "",
				ExecutionPending: "",
		...
		AffirmationStatus: {
			_enum: { Unknown: "", Pending: "", Affirmed: "", Rejected: "" },
		},
		SettlementType: {
			_enum: { SettleOnAffirmation: "", SettleOnBlock: "BlockNumber" },
		},
		Instruction: {
			instruction_id: "u64",
			venue_id: "u64",
		...
		TargetIdentity: { _enum: { ExternalAgent: "", Specific: "IdentityId" } },
		FundraiserName: "Text",
		...
		CADetails: "Text",
		CACheckpoint: {
			_enum: { Scheduled: "(ScheduleId, u64)", Existing: "CheckpointId" },
		},
		...
		AssetMigrationError: {
			_enum: { AssetDocumentFail: "(Ticker, DocumentId)" },
		},
		MigrationError: {
			_enum: { DecodeKey: "Vec<u8>", Map: "AssetMigrationError" },
		},
		...
		ItnRewardStatus: { _enum: { Unclaimed: "Balance", Claimed: "" } },
	},
};
