import { createApi, initMain, generateRandomKey, generateKeys, transferAmount, handle } from "../util/init";
...
async function main(): Promise<void> {
	...
	const [polyBatchErr] = await handle(distributePolyBatch(api.api, keys, transferAmount, alice));
