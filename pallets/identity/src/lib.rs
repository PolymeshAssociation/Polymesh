...
use polymesh_primitives::{
    AuthIdentifier, Authorization, AuthorizationData, AuthorizationError, CddId, Claim, ClaimType,
    Identity as DidRecord, IdentityClaim, IdentityId, InvestorUID, JoinIdentityData, Link,
    LinkData, Permission, Scope, Signatory, SignatoryType, SigningItem, Ticker,
};
    ...
    add_extra_genesis {
        ...
        build(|config: &GenesisConfig<T>| {
            ...
            for &(ref master_account_id, issuer, did, investor_uid, expiry) in &config.identities {
                let cdd_id = CddId::new( did.clone(), investor_uid);
                ...
                <Module<T>>::unsafe_add_claim( did, Claim::CustomerDueDiligence(cdd_id), issuer, expiry);
            }
...
decl_module! {
    ...
    pub struct Module<T: Trait> for enum Call where origin: T::Origin {
        ...
        #[weight = FunctionOf(
            |(_, items): (&T::AccountId, &Vec<SigningItem<T::AccountId>>)| {
        ...
        /// `150_000 + 50_000 * auths.len()`
        #[weight = FunctionOf(
            |(auths,): (&Vec<AuthIdentifier<T::AccountId>>,)| {
        ...
        #[weight = FunctionOf(
            |(additional_keys, _): (&Vec<SigningItemWithAuth<T::AccountId>>, &T::Moment)| {
