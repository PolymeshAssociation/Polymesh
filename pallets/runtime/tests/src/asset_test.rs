...
use pallet_asset::{
    ...
    ClassicTickerRegistration, ClassicTickers, FundingRoundName, IdentifierType, ScopeIdOf,
...
use polymesh_primitives::{
    ...
    InvestorUid, PortfolioId, Signatory, SmartExtension, SmartExtensionName, SmartExtensionType,
    Ticker,
};
