...
fn no_candidate_emergency_condition() {
    ExtBuilder::default()
        ...
        .build_and_execute(|| {
            ...
            pallet_staking::Validators::<Test>::insert(11, prefs.clone());

            // set the minimum validator count.
            pallet_staking::MinimumValidatorCount::<Test>::put(10);
            ...
            assert!(!pallet_staking::Validators::<Test>::contains_key(11));
            // No new era is created.
            assert_eq!(current_era, CurrentEra::<Test>::get());
        });
}
...
fn slash_in_old_span_does_not_deselect() {
    ExtBuilder::default().build_and_execute(|| {
        ...
        assert!(pallet_staking::Validators::<Test>::iter().any(|(stash, _)| stash == 11));
...
fn garbage_collection_after_slashing() {
    ...
    ExtBuilder::default()
        ...
        .build_and_execute(|| {
            ...
            assert!(pallet_staking::SlashingSpans::<Test>::get(&11).is_some());
            assert_eq!(
                pallet_staking::SpanSlash::<Test>::get(&(11, 0)).amount(),
                &200
            );
            ...
            let slashing_spans = pallet_staking::SlashingSpans::<Test>::get(&11).unwrap();
...
fn garbage_collection_on_window_pruning() {
    ...
    ExtBuilder::default().build_and_execute(|| {
        ...
        assert!(pallet_staking::ValidatorSlashInEra::<Test>::get(&now, &11).is_none());
...
fn slashing_nominators_by_span_max() {
    ExtBuilder::default().build_and_execute(|| {
        ...
        let get_span = |account| pallet_staking::SlashingSpans::<Test>::get(&account).unwrap();
...
fn remove_multi_deferred() {
    ExtBuilder::default()
        ...
        .build_and_execute(|| {
            ...
            assert_eq!(pallet_staking::UnappliedSlashes::<Test>::get(&4).len(), 5);
            ...
            let slashes = pallet_staking::UnappliedSlashes::<Test>::get(&4);
    ...
    ExtBuilder::default()
        ...
        .build_and_execute(|| {
            ...
            for i in 0..100 {
                ...
                bond_nominator_cdd(1000 + i, 100 + i, bond_amount, vec![11]);
...
fn cannot_rebond_to_lower_than_ed() {
    ExtBuilder::default()
        ...
        .build_and_execute(|| {
            ...
            // Polymesh change
            // -----------------------------------------------------------------
            assert_ok!(Staking::rebond(RuntimeOrigin::signed(20), 5),);
            // -----------------------------------------------------------------
        })
}
...
fn change_of_max_nominations() {
    ...
    ExtBuilder::default()
        ...
        .build_and_execute(|| {
            ...
            assert_ok!(Staking::nominate(RuntimeOrigin::signed(70), vec![1]));
            assert_eq!(
                Nominators::<Test>::iter()
                    .map(|(k, n)| (k, n.targets.len()))
                    .collect::<Vec<_>>(),
            ...
            assert_ok!(Staking::chill_other(RuntimeOrigin::signed(71), 100));
            assert!(!Nominators::<Test>::contains_key(101));
            assert!(Nominators::<Test>::get(101).is_none());
        })
}
...
fn reducing_max_unlocking_chunks_abrupt() {
    ...
    ExtBuilder::default().build_and_execute(|| {
        ...
        assert_noop!(
            Staking::unbond(RuntimeOrigin::signed(4), 20),
            Error::<Test>::NoMoreChunks
        );
        ...
        assert_noop!(
            Staking::rebond(RuntimeOrigin::signed(4), 100),
            Error::<Test>::NotController
        );
