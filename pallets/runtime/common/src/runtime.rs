            ...
            fn contains(call: &RuntimeCall) -> bool {
                match call {
                    ...
                    RuntimeCall::MultiSig(call) => match call {
                        ...
                        pallet_multisig::Call::add_multisig_signers_via_creator { .. } => true,
                        pallet_multisig::Call::remove_multisig_signers_via_creator { .. } => true,
                        pallet_multisig::Call::change_sigs_required { .. } => true,
                        pallet_multisig::Call::change_sigs_required_via_creator { .. } => true,
                        pallet_multisig::Call::remove_creator_controls { .. } => true,
                        _ => false,
                    },
                    _ => false,
                }
