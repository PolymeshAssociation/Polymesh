...
decl_storage! {
    trait Store for Module<T: Trait> as MultiSig {
        ...
        pub MultiSigSigners: double_map hasher(identity) T::AccountId, hasher(blake2_128_concat) Signatory => Signatory;
        ...
        pub ProposalIds get(fn proposal_ids):
            double_map hasher(identity) T::AccountId, hasher(blake2_256) T::Proposal => Option<u64>;
