...
decl_module! {
    ...
    pub struct Module<T: Trait> for enum Call where origin: T::Origin {
        ...
        ///
        /// # Weight
        /// `80_000_000 + 3_000_000 * signers.len()`
        #[weight = 80_000_000 + 3_000_000 * u64::try_from(signers.len()).unwrap_or_default()]
        ...
        ///
        /// # Weight
        /// `60_000_000 + 3_000_000 * signers.len()`
        #[weight = 60_000_000 + 3_000_000 * u64::try_from(signers.len()).unwrap_or_default()]
