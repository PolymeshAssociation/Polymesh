...
decl_event!(
        ...
        Moment = <T as pallet_timestamp::Trait>::Moment,
    {
        ...
        /// (authorized_identity, auth_id)
        AuthorizationRevoked(Signatory, u64),

        /// Authorization rejected by the user who was authorized.
        /// (authorized_identity, auth_id)
        AuthorizationRejected(Signatory, u64),

        /// Authorization consumed.
        /// (authorized_identity, auth_id)
        AuthorizationConsumed(Signatory, u64),
        ...
        LinkRemoved(Signatory, u64),

        /// Link contents updated.
        /// (associated identity or key, link_id)
        LinkUpdated(Signatory, u64),
