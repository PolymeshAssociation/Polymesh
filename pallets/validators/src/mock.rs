...
pub use sp_staking::{
  Exposure, IndividualExposure, StakerStatus,
  EraIndex, ExposurePage, PagedExposureMetadata, SessionIndex,
};
pub use frame_election_provider_support::ElectionProvider;
pub use sp_runtime::{Perbill};
pub use alloc::{collections::btree_map::BTreeMap, vec, vec::Vec};
pub use frame_support::traits::Contains;

//use crate::{self as pallet_staking, *};
use frame_election_provider_support::{
	bounds::{ElectionBounds, ElectionBoundsBuilder},
	onchain, BoundedSupports, SequentialPhragmen, Support,
};
use frame_support::{
...
impl pallet_staking::pallet::pallet::Config for Test {
