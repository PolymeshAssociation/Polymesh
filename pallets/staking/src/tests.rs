...
fn chill_other_works() {
	ExtBuilder::default()
		...
		.build_and_execute(|| {
			...
			assert_noop!(
				Staking::chill_other(RuntimeOrigin::signed(1337), base + 1),
				Error::<Test>::CannotChillOther
			);
			assert_noop!(
				Staking::chill_other(RuntimeOrigin::signed(1337), base + 3),
				Error::<Test>::CannotChillOther
			);
			...
			assert_ok!(Staking::chill_other(RuntimeOrigin::signed(1337), base + 3));
		})
}
