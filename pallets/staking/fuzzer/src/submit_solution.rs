...
use pallet_staking::{Call as StakingCall, ElectionStatus, EraElectionStatus, Module as Staking};
    ...
    loop {
        fuzz!(|data: (u32, u32, u32, u32, u32)| {
            ...
            println!(
                ...
                num_nominators, num_validators, edge_per_voter, to_elect, mode, mode_u32,
            );
            ...
            ext.execute_with(|| {
                ...
                let (winners, compact, score, size) = match mode {
                    ...
                    Mode::StrongerSubmission => {
                        ...
                        assert_ok!(<Staking<Test>>::submit_election_solution(
                            origin.clone().into(),
                            winners,
                            compact,
                            score,
