...
decl_event!(
        ...
        AccountId = <T as frame_system::Trait>::AccountId,
    {
        ...
        /// A receipt has been invalidated (did, signer, receipt_uid)
        ReceiptInvalidated(IdentityId, AccountId, u64),
        /// A receipt has been revalidated (did, signer, receipt_uid)
        ReceiptRevalidated(IdentityId, AccountId, u64),
...
decl_module! {
    pub struct Module<T: Trait> for enum Call where origin: <T as frame_system::Trait>::Origin {
        ...
        /// Marks a receipt issued by the caller as already claimed.
        ///
        /// * `receipt_uid` - Unique ID of the receipt.
        #[weight = <T as Trait>::WeightInfo::invalidate_receipt()]
        pub fn invalidate_receipt(origin, receipt_uid: u64) {
            ...
            Self::deposit_event(RawEvent::ReceiptInvalidated(primary_did, signer, receipt_uid));
        }

        /// Marks a receipt issued by the caller as not claimed.
        ///
        /// * `receipt_uid` - Unique ID of the receipt.
        #[weight = <T as Trait>::WeightInfo::revalidate_receipt()]
        pub fn revalidate_receipt(origin, receipt_uid: u64) {
            let PermissionedCallOriginData {
                primary_did,
                sender: signer,
                ..
            ...
            <ReceiptsUsed<T>>::insert(&signer, receipt_uid, false);
            Self::deposit_event(RawEvent::ReceiptRevalidated(primary_did, signer, receipt_uid));
        }
