...
benchmarks! {
    ...
    execute_scheduled_instruction {
        ...
        let before_transfer_balance = PortfolioAssetBalances::get(first_leg.from, first_leg_asset);
    ...
    verify {
        ...
        let after_transfer_balance = PortfolioAssetBalances::get(first_leg.from, first_leg_asset);
