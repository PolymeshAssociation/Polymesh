...
impl pallet_test_utils::WeightInfo for SubstrateWeight {
    ...
    fn register_did(i: u32) -> Weight {
        // Minimum execution time: 1_178_395 nanoseconds.
        Weight::from_ref_time(1_403_888_164)
            // Standard Error: 786_818
            .saturating_add(Weight::from_ref_time(19_947_469).saturating_mul(i.into()))
    ...
    fn mock_cdd_register_did() -> Weight {
        // Minimum execution time: 1_263_111 nanoseconds.
        Weight::from_ref_time(1_405_427_000)
            .saturating_add(DbWeight::get().reads(10))
            .saturating_add(DbWeight::get().writes(5))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    fn get_my_did() -> Weight {
        // Minimum execution time: 55_028 nanoseconds.
        Weight::from_ref_time(57_871_000).saturating_add(DbWeight::get().reads(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    // Storage: Timestamp Now (r:1 w:0)
    // Storage: Instance2Group ActiveMembers (r:1 w:0)
    ...
    fn get_cdd_of() -> Weight {
        // Minimum execution time: 105_442 nanoseconds.
        Weight::from_ref_time(110_023_000).saturating_add(DbWeight::get().reads(6))
    }
}
