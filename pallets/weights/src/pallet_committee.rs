...
impl pallet_committee::WeightInfo for WeightInfo {
    ...
    fn set_vote_threshold() -> Weight {
        (57_429_000 as Weight).saturating_add(DbWeight::get().writes(1 as Weight))
    }
