...
impl pallet_committee::WeightInfo for SubstrateWeight {
    ...
    fn set_vote_threshold() -> Weight {
        ...
        Weight::from_ref_time(11_086_000).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn set_release_coordinator() -> Weight {
        ...
        Weight::from_ref_time(43_294_000)
    ...
    fn set_expires_after() -> Weight {
        // Minimum execution time: 10_125 nanoseconds.
        Weight::from_ref_time(11_828_000).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn vote_or_propose_new_proposal() -> Weight {
        // Minimum execution time: 136_877 nanoseconds.
        Weight::from_ref_time(145_401_000)
    ...
    fn vote_or_propose_existing_proposal() -> Weight {
        // Minimum execution time: 106_871 nanoseconds.
        Weight::from_ref_time(119_370_000)
    ...
    // Proof Skipped: Instance1Committee Proposals (max_values: Some(1), max_size: None, mode: Measured)
    fn vote_aye() -> Weight {
        // Minimum execution time: 257_720 nanoseconds.
        Weight::from_ref_time(279_472_000)
    ...
    // Proof Skipped: Instance1Committee VoteThreshold (max_values: Some(1), max_size: None, mode: Measured)
    fn vote_nay() -> Weight {
        // Minimum execution time: 98_048 nanoseconds.
        Weight::from_ref_time(103_557_000)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(1))
    }
}
