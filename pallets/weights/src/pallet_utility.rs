...
impl pallet_utility::WeightInfo for SubstrateWeight {
    ...
    fn batch(c: u32) -> Weight {
        ...
        Weight::from_ref_time(57_533_943)
            // Standard Error: 13_144
            .saturating_add(Weight::from_ref_time(13_011_895).saturating_mul(c.into()))
    ...
    fn batch_all(c: u32) -> Weight {
        ...
        Weight::from_ref_time(32_333_224)
            // Standard Error: 20_392
            .saturating_add(Weight::from_ref_time(13_058_702).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(2))
    }
    ...
    fn force_batch(c: u32) -> Weight {
        ...
        Weight::from_ref_time(99_965_865)
            // Standard Error: 40_995
            .saturating_add(Weight::from_ref_time(12_851_227).saturating_mul(c.into()))
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(2))
    }
    ...
    // Proof Skipped: Permissions CurrentDispatchableName (max_values: Some(1), max_size: None, mode: Measured)
    fn relay_tx() -> Weight {
        // Minimum execution time: 175_074 nanoseconds.
        Weight::from_ref_time(190_597_000)
            .saturating_add(DbWeight::get().reads(8))
            .saturating_add(DbWeight::get().writes(3))
    }
    fn ensure_root() -> Weight {
        // Minimum execution time: 640 nanoseconds.
        Weight::from_ref_time(831_000)
    }
    // Storage: Identity CurrentPayer (r:1 w:1)
    // Proof: Identity CurrentPayer (max_values: Some(1), max_size: Some(32), added: 527, mode: MaxEncodedLen)
    // Storage: Permissions CurrentPalletName (r:1 w:1)
