...
//! DATE: 2023-05-08, STEPS: `100`, REPEAT: 5, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl pallet_confidential_asset::WeightInfo for SubstrateWeight {
    ...
    fn validate_mercat_account() -> Weight {
        // Minimum execution time: 3_173_470 nanoseconds.
        Weight::from_ref_time(3_284_304_000)
    ...
    fn add_mediator_mercat_account() -> Weight {
        // Minimum execution time: 206_226 nanoseconds.
        Weight::from_ref_time(206_864_000)
    ...
    fn create_confidential_asset() -> Weight {
        // Minimum execution time: 92_471 nanoseconds.
        Weight::from_ref_time(94_719_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity CurrentDid (r:1 w:0)
    ...
    fn mint_confidential_asset() -> Weight {
        // Minimum execution time: 5_777_746 nanoseconds.
        Weight::from_ref_time(5_835_605_000)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn add_transaction() -> Weight {
        // Minimum execution time: 339_004 nanoseconds.
        Weight::from_ref_time(340_974_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn sender_affirm_transaction() -> Weight {
        // Minimum execution time: 61_033_677 nanoseconds.
        Weight::from_ref_time(61_072_788_000)
    ...
    fn receiver_affirm_transaction() -> Weight {
        // Minimum execution time: 1_835_305 nanoseconds.
        Weight::from_ref_time(2_273_011_000)
    ...
    fn mediator_affirm_transaction() -> Weight {
        // Minimum execution time: 1_731_747 nanoseconds.
        Weight::from_ref_time(1_824_631_000)
            .saturating_add(DbWeight::get().reads(3))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn execute_transaction() -> Weight {
        // Minimum execution time: 60_864_321 nanoseconds.
        Weight::from_ref_time(60_891_762_000)
    ...
    fn reset_ordering_state() -> Weight {
        // Minimum execution time: 737_426 nanoseconds.
        Weight::from_ref_time(738_377_000).saturating_add(DbWeight::get().reads(5))
    }
}
