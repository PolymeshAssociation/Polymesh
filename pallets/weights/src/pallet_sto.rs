...
impl pallet_sto::WeightInfo for SubstrateWeight {
    ...
    fn create_fundraiser(i: u32) -> Weight {
        ...
        Weight::from_ref_time(248_085_188)
            ...
            .saturating_add(Weight::from_ref_time(512_895).saturating_mul(i.into()))
    ...
    fn invest() -> Weight {
        // Minimum execution time: 1_682_364 nanoseconds.
        Weight::from_ref_time(2_046_404_000)
    ...
    fn freeze_fundraiser() -> Weight {
        ...
        Weight::from_ref_time(90_169_000)
    ...
    fn unfreeze_fundraiser() -> Weight {
        // Minimum execution time: 85_551 nanoseconds.
        Weight::from_ref_time(99_546_000)
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn modify_fundraiser_window() -> Weight {
        // Minimum execution time: 138_159 nanoseconds.
        Weight::from_ref_time(201_697_000)
    ...
    // Proof: Timestamp Now (max_values: Some(1), max_size: Some(8), added: 503, mode: MaxEncodedLen)
    fn stop() -> Weight {
        // Minimum execution time: 82_234 nanoseconds.
        Weight::from_ref_time(104_465_000)
