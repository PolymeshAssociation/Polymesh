...
impl pallet_asset::checkpoint::WeightInfo for SubstrateWeight {
    ...
    fn set_schedules_max_complexity() -> Weight {
        ...
        Weight::from_ref_time(11_397_000).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn create_checkpoint() -> Weight {
        // Minimum execution time: 57_667 nanoseconds.
        Weight::from_ref_time(59_941_000)
    ...
    fn create_schedule() -> Weight {
        // Minimum execution time: 80_922 nanoseconds.
        Weight::from_ref_time(84_689_000)
    ...
    fn remove_schedule() -> Weight {
        // Minimum execution time: 74_282 nanoseconds.
        Weight::from_ref_time(81_653_000)
            .saturating_add(DbWeight::get().reads(7))
            .saturating_add(DbWeight::get().writes(3))
    }
}
