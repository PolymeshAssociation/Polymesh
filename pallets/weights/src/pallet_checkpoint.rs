...
impl pallet_asset::checkpoint::WeightInfo for SubstrateWeight {
    ...
    fn set_schedules_max_complexity() -> Weight {
        // Minimum execution time: 9_298 nanoseconds.
        Weight::from_parts(11_051_000, 0).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn create_checkpoint() -> Weight {
        // Minimum execution time: 67_738 nanoseconds.
        Weight::from_parts(72_918_000, 0)
    ...
    fn create_schedule() -> Weight {
        // Minimum execution time: 91_835 nanoseconds.
        Weight::from_parts(97_364_000, 0)
    ...
    fn remove_schedule() -> Weight {
        // Minimum execution time: 82_156 nanoseconds.
        Weight::from_parts(86_525_000, 0)
            .saturating_add(DbWeight::get().reads(7))
            .saturating_add(DbWeight::get().writes(3))
    }
}
