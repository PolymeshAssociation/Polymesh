...
impl pallet_corporate_actions::ballot::WeightInfo for SubstrateWeight {
    ...
    fn attach_ballot(c: u32) -> Weight {
        // Minimum execution time: 66_924 nanoseconds.
        Weight::from_ref_time(68_942_016 as u64)
            // Standard Error: 1_588
            .saturating_add(Weight::from_ref_time(34_271 as u64).saturating_mul(c as u64))
    ...
    fn vote(c: u32, t: u32) -> Weight {
        // Minimum execution time: 116_224 nanoseconds.
        Weight::from_ref_time(46_507_296 as u64)
            // Standard Error: 3_137
            .saturating_add(Weight::from_ref_time(94_302 as u64).saturating_mul(c as u64))
            // Standard Error: 3_137
            .saturating_add(Weight::from_ref_time(221_389 as u64).saturating_mul(t as u64))
    ...
    fn change_end() -> Weight {
        // Minimum execution time: 51_445 nanoseconds.
        Weight::from_ref_time(53_549_000 as u64)
    ...
    fn change_meta(c: u32) -> Weight {
        // Minimum execution time: 52_648 nanoseconds.
        Weight::from_ref_time(58_720_245 as u64)
            // Standard Error: 2_777
            .saturating_add(Weight::from_ref_time(42_176 as u64).saturating_mul(c as u64))
            .saturating_add(DbWeight::get().reads(6 as u64))
            .saturating_add(DbWeight::get().writes(2 as u64))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn change_rcv() -> Weight {
        // Minimum execution time: 51_666 nanoseconds.
        Weight::from_ref_time(53_719_000 as u64)
            .saturating_add(DbWeight::get().reads(6 as u64))
            .saturating_add(DbWeight::get().writes(1 as u64))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn remove_ballot() -> Weight {
        ...
        Weight::from_ref_time(69_789_000 as u64)
            .saturating_add(DbWeight::get().reads(6 as u64))
            .saturating_add(DbWeight::get().writes(4 as u64))
    }
}
