...
impl pallet_protocol_fee::WeightInfo for SubstrateWeight {
    ...
    fn change_coefficient() -> Weight {
        ...
        Weight::from_ref_time(37_665_000).saturating_add(DbWeight::get().writes(1))
    }
    // Storage: ProtocolFee BaseFees (r:0 w:1)
    fn change_base_fee() -> Weight {
        // Minimum execution time: 36_746 nanoseconds.
        Weight::from_ref_time(38_534_000).saturating_add(DbWeight::get().writes(1))
    }
}
