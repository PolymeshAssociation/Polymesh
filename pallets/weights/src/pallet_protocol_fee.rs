...
impl pallet_protocol_fee::WeightInfo for SubstrateWeight {
    ...
    fn change_coefficient() -> Weight {
        // Minimum execution time: 10_236 nanoseconds.
    ...
    fn change_base_fee() -> Weight {
        // Minimum execution time: 10_796 nanoseconds.
        Weight::from_ref_time(11_808_000).saturating_add(DbWeight::get().writes(1))
    }
}
