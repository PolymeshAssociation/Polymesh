...
impl pallet_protocol_fee::WeightInfo for SubstrateWeight {
    ...
    fn change_coefficient() -> Weight {
        ...
        Weight::from_ref_time(18_384_000 as u64).saturating_add(DbWeight::get().writes(1 as u64))
    }
    // Storage: ProtocolFee BaseFees (r:0 w:1)
    fn change_base_fee() -> Weight {
        // Minimum execution time: 17_833 nanoseconds.
        Weight::from_ref_time(18_334_000 as u64).saturating_add(DbWeight::get().writes(1 as u64))
    }
}
