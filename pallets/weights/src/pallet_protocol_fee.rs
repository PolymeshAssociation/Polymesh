...
impl pallet_protocol_fee::WeightInfo for SubstrateWeight {
    ...
    fn change_coefficient() -> Weight {
        ...
        Weight::from_parts(10_911_000, 0).saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn change_base_fee() -> Weight {
        // Minimum execution time: 11_322 nanoseconds.
        Weight::from_parts(13_205_000, 0).saturating_add(DbWeight::get().writes(1))
    }
}
