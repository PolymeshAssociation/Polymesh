...
impl pallet_relayer::WeightInfo for SubstrateWeight {
    ...
    fn set_paying_key() -> Weight {
        // Minimum execution time: 32_408 nanoseconds.
    ...
    fn accept_paying_key() -> Weight {
        // Minimum execution time: 55_594 nanoseconds.
        Weight::from_ref_time(59_840_000)
    ...
    fn remove_paying_key() -> Weight {
        ...
        Weight::from_ref_time(37_155_000)
    ...
    fn update_polyx_limit() -> Weight {
        // Minimum execution time: 22_664 nanoseconds.
    ...
    fn increase_polyx_limit() -> Weight {
        ...
        Weight::from_ref_time(25_760_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn decrease_polyx_limit() -> Weight {
        ...
        Weight::from_ref_time(26_912_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(1))
    }
}
