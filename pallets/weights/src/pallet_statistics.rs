...
impl pallet_statistics::WeightInfo for SubstrateWeight {
    ...
    fn set_active_asset_stats(i: u32) -> Weight {
        ...
        Weight::from_ref_time(118_914_894)
            // Standard Error: 8_840
            .saturating_add(Weight::from_ref_time(190_193).saturating_mul(i.into()))
    ...
    fn batch_update_asset_stats(i: u32) -> Weight {
        // Minimum execution time: 197_566 nanoseconds.
        Weight::from_ref_time(222_634_051)
            // Standard Error: 123_781
            .saturating_add(Weight::from_ref_time(4_981_518).saturating_mul(i.into()))
    ...
    fn set_asset_transfer_compliance(i: u32) -> Weight {
        // Minimum execution time: 201_021 nanoseconds.
        Weight::from_ref_time(3_989_630_599)
            // Standard Error: 1_134_782
            .saturating_add(Weight::from_ref_time(79_615_414).saturating_mul(i.into()))
            .saturating_add(DbWeight::get().reads(6))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn set_entities_exempt(i: u32) -> Weight {
        ...
        Weight::from_ref_time(51_332_551)
            // Standard Error: 96_574
            .saturating_add(Weight::from_ref_time(4_768_017).saturating_mul(i.into()))
