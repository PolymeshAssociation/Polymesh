...
impl pallet_group::WeightInfo for SubstrateWeight {
    ...
    fn add_member() -> Weight {
        // Minimum execution time: 80_100 nanoseconds.
        Weight::from_parts(90_141_000, 0)
    ...
    fn remove_member() -> Weight {
        // Minimum execution time: 63_950 nanoseconds.
    ...
    fn disable_member() -> Weight {
        ...
        Weight::from_parts(88_669_000, 0)
            .saturating_add(DbWeight::get().reads(4))
    ...
    fn swap_member() -> Weight {
        // Minimum execution time: 96_370 nanoseconds.
        Weight::from_parts(106_850_000, 0)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(3))
    }
    // Storage: `DidRegistrars::ActiveMembersLimit` (r:1 w:0)
    ...
    fn reset_members(m: u32) -> Weight {
        // Minimum execution time: 38_910 nanoseconds.
        Weight::from_parts(7_799_834, 0)
            // Standard Error: 34_867
            .saturating_add(Weight::from_parts(9_628_653, 0).saturating_mul(m.into()))
            .saturating_add(DbWeight::get().reads(4))
    ...
    fn abdicate_membership() -> Weight {
        // Minimum execution time: 89_540 nanoseconds.
        Weight::from_parts(96_390_000, 0)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(2))
    }
}
