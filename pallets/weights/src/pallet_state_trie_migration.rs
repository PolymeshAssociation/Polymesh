...
impl pallet_state_trie_migration::WeightInfo for SubstrateWeight {
    ...
    // Proof: StateTrieMigration MigrationProcess (max_values: Some(1), max_size: Some(4114), added: 4609, mode: MaxEncodedLen)
    fn continue_migrate() -> Weight {
        // Minimum execution time: 16_985 nanoseconds.
        Weight::from_ref_time(19_039_000)
    ...
    fn continue_migrate_wrong_witness() -> Weight {
        // Minimum execution time: 5_989 nanoseconds.
        Weight::from_ref_time(6_239_000).saturating_add(DbWeight::get().reads(1))
    }
    fn migrate_custom_top_success() -> Weight {
        // Minimum execution time: 10_255 nanoseconds.
        Weight::from_ref_time(11_318_000)
    }
    // Storage: unknown `0x666f6f` (r:1 w:1)
    // Proof Skipped: unknown `0x666f6f` (r:1 w:1)
    fn migrate_custom_top_fail() -> Weight {
        // Minimum execution time: 23_066 nanoseconds.
        Weight::from_ref_time(24_708_000)
            .saturating_add(DbWeight::get().reads(1))
            .saturating_add(DbWeight::get().writes(1))
    }
    fn migrate_custom_child_success() -> Weight {
        // Minimum execution time: 9_975 nanoseconds.
        Weight::from_ref_time(11_649_000)
    }
    // Storage: unknown `0x666f6f` (r:1 w:1)
    // Proof Skipped: unknown `0x666f6f` (r:1 w:1)
    ...
    fn process_top_key(v: u32) -> Weight {
        ...
        Weight::from_ref_time(6_780_000)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(1_045).saturating_mul(v.into()))
            .saturating_add(DbWeight::get().reads(1))
            .saturating_add(DbWeight::get().writes(1))
    }
}
