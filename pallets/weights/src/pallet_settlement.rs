...
impl pallet_settlement::WeightInfo for WeightInfo {
    ...
    fn execute_scheduled_instruction(f: u32, n: u32) -> Weight {
        (311_175_455 as Weight)
            // Standard Error: 5_950_000
            .saturating_add((505_702_752 as Weight).saturating_mul(f as Weight))
            .saturating_add((399_295_432 as Weight).saturating_mul(n as Weight))
            .saturating_add(DbWeight::get().reads(59 as Weight))
            .saturating_add(DbWeight::get().reads((24 as Weight).saturating_mul(f as Weight)))
