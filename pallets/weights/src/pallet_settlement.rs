...
/// Weight functions needed for pallet_settlement.
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add_instruction(l: u32, ) -> Weight {
		(52_527_000 as Weight)
			...
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
			.saturating_add(T::DbWeight::get().writes((3 as Weight).saturating_mul(l as Weight)))
	}
	fn add_instruction_with_settle_on_block_type(l: u32, ) -> Weight {
	...
	fn add_and_affirm_instruction(l: u32, ) -> Weight {
		(135_882_000 as Weight)
			...
			.saturating_add(T::DbWeight::get().reads(8 as Weight))
			.saturating_add(T::DbWeight::get().reads((5 as Weight).saturating_mul(l as Weight)))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
	...
	fn withdraw_affirmation(l: u32, ) -> Weight {
		(84_006_000 as Weight)
			...
			.saturating_add(T::DbWeight::get().reads((5 as Weight).saturating_mul(l as Weight)))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
			.saturating_add(T::DbWeight::get().writes((4 as Weight).saturating_mul(l as Weight)))
	}
	fn unclaim_receipt() -> Weight {
	...
	fn affirm_instruction(l: u32, ) -> Weight {
		(107_230_000 as Weight)
			...
			.saturating_add(T::DbWeight::get().writes((2 as Weight).saturating_mul(l as Weight)))
	}
	fn claim_receipt() -> Weight {
	...
	fn execute_scheduled_instruction(l: u32, ) -> Weight {
		(201_656_000 as Weight)
			...
			.saturating_add(T::DbWeight::get().reads((31 as Weight).saturating_mul(l as Weight)))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
			.saturating_add(T::DbWeight::get().writes((16 as Weight).saturating_mul(l as Weight)))
	}
	fn reschedule_instruction() -> Weight {
...
impl WeightInfo for () {
	...
	fn add_instruction(l: u32, ) -> Weight {
		(52_527_000 as Weight)
			...
			.saturating_add((24_260_000 as Weight).saturating_mul(l as Weight))
			.saturating_add(RocksDbWeight::get().reads(6 as Weight))
			.saturating_add(RocksDbWeight::get().reads((1 as Weight).saturating_mul(l as Weight)))
			.saturating_add(RocksDbWeight::get().writes(1 as Weight))
			.saturating_add(RocksDbWeight::get().writes((3 as Weight).saturating_mul(l as Weight)))
	}
	fn add_instruction_with_settle_on_block_type(l: u32, ) -> Weight {
		(100_668_000 as Weight)
			// Standard Error: 699_000
	...
	fn add_and_affirm_instruction(l: u32, ) -> Weight {
		(135_882_000 as Weight)
			...
			.saturating_add((79_895_000 as Weight).saturating_mul(l as Weight))
			.saturating_add(RocksDbWeight::get().reads(8 as Weight))
			.saturating_add(RocksDbWeight::get().reads((5 as Weight).saturating_mul(l as Weight)))
			.saturating_add(RocksDbWeight::get().writes(4 as Weight))
			.saturating_add(RocksDbWeight::get().writes((6 as Weight).saturating_mul(l as Weight)))
	}
	fn add_and_affirm_instruction_with_settle_on_block_type(l: u32, ) -> Weight {
		(179_262_000 as Weight)
			// Standard Error: 1_798_000
	...
	fn withdraw_affirmation(l: u32, ) -> Weight {
		(84_006_000 as Weight)
			...
			.saturating_add(RocksDbWeight::get().reads((5 as Weight).saturating_mul(l as Weight)))
			.saturating_add(RocksDbWeight::get().writes(1 as Weight))
			.saturating_add(RocksDbWeight::get().writes((4 as Weight).saturating_mul(l as Weight)))
	}
	fn unclaim_receipt() -> Weight {
		(124_357_000 as Weight)
			.saturating_add(RocksDbWeight::get().reads(10 as Weight))
	...
	fn reject_instruction(l: u32, ) -> Weight {
		(131_459_000 as Weight)
			...
			.saturating_add((54_210_000 as Weight).saturating_mul(l as Weight))
			.saturating_add(RocksDbWeight::get().reads(8 as Weight))
			.saturating_add(RocksDbWeight::get().reads((3 as Weight).saturating_mul(l as Weight)))
			.saturating_add(RocksDbWeight::get().writes(3 as Weight))
			.saturating_add(RocksDbWeight::get().writes((6 as Weight).saturating_mul(l as Weight)))
	}
	fn affirm_instruction(l: u32, ) -> Weight {
		(107_230_000 as Weight)
			...
			.saturating_add(RocksDbWeight::get().writes((2 as Weight).saturating_mul(l as Weight)))
	}
	fn claim_receipt() -> Weight {
		(196_347_000 as Weight)
	...
	fn execute_scheduled_instruction(l: u32, ) -> Weight {
		(201_656_000 as Weight)
			// Standard Error: 8_108_000
			.saturating_add((1_166_394_000 as Weight).saturating_mul(l as Weight))
			.saturating_add(RocksDbWeight::get().reads(38 as Weight))
			.saturating_add(RocksDbWeight::get().reads((31 as Weight).saturating_mul(l as Weight)))
			.saturating_add(RocksDbWeight::get().writes(4 as Weight))
			.saturating_add(RocksDbWeight::get().writes((16 as Weight).saturating_mul(l as Weight)))
	}
	fn reschedule_instruction() -> Weight {
		(229_782_000 as Weight)
