...
impl pallet_portfolio::WeightInfo for WeightInfo {
    ...
    fn move_portfolio_funds(a: u32) -> Weight {
        (0 as Weight)
            ...
            .saturating_add((36_127_000 as Weight).saturating_mul(a as Weight))
    ...
    fn rename_portfolio(i: u32) -> Weight {
        (46_093_000 as Weight)
            // Standard Error: 0
            .saturating_add((13_000 as Weight).saturating_mul(i as Weight))
            .saturating_add(DbWeight::get().reads(3 as Weight))
            .saturating_add(DbWeight::get().writes(3 as Weight))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn move_portfolio_funds_v2(f: u32, n: u32) -> Weight {
        (87_313_000 as Weight)
            // Standard Error: 1_943_000
            .saturating_add((29_393_000 as Weight).saturating_mul(f as Weight))
            // Standard Error: 97_000
            .saturating_add((15_196_000 as Weight).saturating_mul(n as Weight))
