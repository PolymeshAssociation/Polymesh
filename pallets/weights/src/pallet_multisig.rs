...
//! DATE: 2024-07-19, STEPS: `10`, REPEAT: 2, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl pallet_multisig::WeightInfo for SubstrateWeight {
    ...
    fn create_multisig(i: u32) -> Weight {
        // Minimum execution time: 33_582 nanoseconds.
        Weight::from_ref_time(31_565_782)
            // Standard Error: 40_989
            .saturating_add(Weight::from_ref_time(9_582_307).saturating_mul(i.into()))
    ...
    fn create_or_approve_proposal() -> Weight {
        // Minimum execution time: 77_464 nanoseconds.
        Weight::from_ref_time(85_068_000)
    ...
    fn create_proposal() -> Weight {
        // Minimum execution time: 72_575 nanoseconds.
        Weight::from_ref_time(85_218_000)
    ...
    fn approve() -> Weight {
        ...
        Weight::from_ref_time(68_437_000)
            .saturating_add(DbWeight::get().reads(10))
            .saturating_add(DbWeight::get().writes(5))
    }
    // Storage: MultiSig Proposals (r:1 w:0)
    ...
    fn execute_proposal() -> Weight {
        ...
        Weight::from_ref_time(27_652_000)
    ...
    fn reject() -> Weight {
        // Minimum execution time: 45_755 nanoseconds.
        Weight::from_ref_time(51_566_000)
    ...
    fn accept_multisig_signer() -> Weight {
        // Minimum execution time: 51_225 nanoseconds.
        Weight::from_ref_time(58_148_000)
            .saturating_add(DbWeight::get().reads(10))
    ...
    fn add_multisig_signers(i: u32) -> Weight {
        // Minimum execution time: 29_505 nanoseconds.
        Weight::from_ref_time(29_505_000)
            // Standard Error: 97_876
            .saturating_add(Weight::from_ref_time(12_953_085).saturating_mul(i.into()))
            .saturating_add(DbWeight::get().reads(4))
    ...
    fn remove_multisig_signers(i: u32) -> Weight {
        // Minimum execution time: 43_601 nanoseconds.
        Weight::from_ref_time(43_601_000)
            // Standard Error: 111_410
            .saturating_add(Weight::from_ref_time(11_819_214).saturating_mul(i.into()))
    ...
    fn add_multisig_signers_via_creator(i: u32) -> Weight {
        ...
        Weight::from_ref_time(46_118_947)
            // Standard Error: 45_707
            .saturating_add(Weight::from_ref_time(12_677_221).saturating_mul(i.into()))
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().writes(2))
            .saturating_add(DbWeight::get().writes((2_u64).saturating_mul(i.into())))
    }
    ...
    fn remove_multisig_signers_via_creator(i: u32) -> Weight {
        // Minimum execution time: 40_465 nanoseconds.
        Weight::from_ref_time(2_845_366)
            // Standard Error: 97_023
            .saturating_add(Weight::from_ref_time(11_934_605).saturating_mul(i.into()))
    ...
    fn change_sigs_required() -> Weight {
        ...
        Weight::from_ref_time(31_058_000)
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:2 w:1)
    ...
    fn make_multisig_secondary() -> Weight {
        ...
        Weight::from_ref_time(33_221_000)
            .saturating_add(DbWeight::get().reads(4))
            .saturating_add(DbWeight::get().writes(2))
    }
    ...
    fn make_multisig_primary() -> Weight {
        ...
        Weight::from_ref_time(48_139_000)
            .saturating_add(DbWeight::get().reads(8))
            .saturating_add(DbWeight::get().writes(5))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn change_sigs_required_via_creator() -> Weight {
        ...
        Weight::from_ref_time(32_851_000)
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn remove_creator_controls() -> Weight {
        // Minimum execution time: 15_539 nanoseconds.
