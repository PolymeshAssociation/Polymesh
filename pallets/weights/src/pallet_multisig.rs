...
//! DATE: 2024-08-05, STEPS: `10`, REPEAT: 2, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl pallet_multisig::WeightInfo for SubstrateWeight {
    ...
    fn create_multisig(i: u32) -> Weight {
        // Minimum execution time: 42_670 nanoseconds.
        Weight::from_ref_time(41_028_024)
            // Standard Error: 76_020
            .saturating_add(Weight::from_ref_time(9_559_003).saturating_mul(i.into()))
    ...
    fn create_proposal() -> Weight {
        ...
        Weight::from_ref_time(59_572_000)
    ...
    fn approve() -> Weight {
        ...
        Weight::from_ref_time(46_718_000)
    ...
    fn execute_proposal() -> Weight {
        // Minimum execution time: 29_025 nanoseconds.
        Weight::from_ref_time(34_254_000)
    ...
    fn accept_multisig_signer() -> Weight {
        ...
        Weight::from_ref_time(55_274_000)
    ...
    fn add_multisig_signers(i: u32) -> Weight {
        ...
        Weight::from_ref_time(29_000_594)
            // Standard Error: 57_115
            .saturating_add(Weight::from_ref_time(9_793_828).saturating_mul(i.into()))
    ...
    fn remove_multisig_signers(i: u32) -> Weight {
        // Minimum execution time: 37_180 nanoseconds.
        Weight::from_ref_time(22_024_751)
            // Standard Error: 71_477
            .saturating_add(Weight::from_ref_time(8_387_877).saturating_mul(i.into()))
    ...
    fn add_multisig_signers_via_admin(i: u32) -> Weight {
        // Minimum execution time: 41_568 nanoseconds.
        Weight::from_ref_time(36_105_608)
            // Standard Error: 58_370
            .saturating_add(Weight::from_ref_time(9_804_023).saturating_mul(i.into()))
            .saturating_add(DbWeight::get().reads(8))
            .saturating_add(DbWeight::get().writes(2))
            .saturating_add(DbWeight::get().writes((2_u64).saturating_mul(i.into())))
    }
    ...
    fn remove_multisig_signers_via_admin(i: u32) -> Weight {
        ...
        Weight::from_ref_time(28_811_165)
            // Standard Error: 65_954
            .saturating_add(Weight::from_ref_time(8_340_053).saturating_mul(i.into()))
            .saturating_add(DbWeight::get().reads(5))
            .saturating_add(DbWeight::get().reads((2_u64).saturating_mul(i.into())))
            .saturating_add(DbWeight::get().writes(3))
            .saturating_add(DbWeight::get().writes((2_u64).saturating_mul(i.into())))
    ...
    fn change_sigs_required() -> Weight {
        // Minimum execution time: 24_877 nanoseconds.
        Weight::from_ref_time(30_637_000)
            .saturating_add(DbWeight::get().reads(5))
    ...
    fn change_sigs_required_via_admin() -> Weight {
        // Minimum execution time: 31_559 nanoseconds.
    ...
    // Proof Skipped: MultiSig AdminDid (max_values: None, max_size: None, mode: Measured)
    fn add_admin() -> Weight {
        // Minimum execution time: 8_826 nanoseconds.
    ...
    fn remove_payer() -> Weight {
        ...
        Weight::from_ref_time(12_733_000)
            .saturating_add(DbWeight::get().reads(1))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:1 w:0)
    ...
    fn remove_payer_via_payer() -> Weight {
        ...
        Weight::from_ref_time(19_025_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(1))
    }
}
