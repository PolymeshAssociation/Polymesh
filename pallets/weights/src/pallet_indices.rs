...
impl pallet_indices::WeightInfo for SubstrateWeight {
    ...
    fn claim() -> Weight {
        ...
        Weight::from_ref_time(33_792_000 as u64)
    ...
    fn transfer() -> Weight {
        ...
        Weight::from_ref_time(40_064_000 as u64)
    ...
    fn free() -> Weight {
        ...
        Weight::from_ref_time(34_524_000 as u64)
            .saturating_add(DbWeight::get().reads(1 as u64))
            .saturating_add(DbWeight::get().writes(1 as u64))
    }
    // Storage: Indices Accounts (r:1 w:1)
    ...
    fn force_transfer() -> Weight {
        ...
        Weight::from_ref_time(35_957_000 as u64)
            .saturating_add(DbWeight::get().reads(2 as u64))
            .saturating_add(DbWeight::get().writes(2 as u64))
    }
    // Storage: Indices Accounts (r:1 w:1)
    fn freeze() -> Weight {
        // Minimum execution time: 35_927 nanoseconds.
        Weight::from_ref_time(36_147_000 as u64)
            .saturating_add(DbWeight::get().reads(1 as u64))
            .saturating_add(DbWeight::get().writes(1 as u64))
    }
}
