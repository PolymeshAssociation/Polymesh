...
impl pallet_indices::WeightInfo for SubstrateWeight {
    ...
    fn claim() -> Weight {
        // Minimum execution time: 32_280 nanoseconds.
        Weight::from_ref_time(32_470_000)
    ...
    fn transfer() -> Weight {
        ...
        Weight::from_ref_time(39_433_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Indices Accounts (r:1 w:1)
    fn free() -> Weight {
        // Minimum execution time: 33_311 nanoseconds.
    ...
    // Storage: Indices Accounts (r:1 w:1)
    fn freeze() -> Weight {
        // Minimum execution time: 34_874 nanoseconds.
        Weight::from_ref_time(35_426_000)
            .saturating_add(DbWeight::get().reads(1))
            .saturating_add(DbWeight::get().writes(1))
    }
}
