...
impl pallet_indices::WeightInfo for SubstrateWeight {
    ...
    fn claim() -> Weight {
        ...
        Weight::from_ref_time(24_287_000)
    ...
    fn transfer() -> Weight {
        // Minimum execution time: 26_910 nanoseconds.
        Weight::from_ref_time(32_108_000)
    ...
    fn force_transfer() -> Weight {
        ...
        Weight::from_ref_time(30_005_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(2))
    }
    // Storage: Indices Accounts (r:1 w:1)
    ...
    fn freeze() -> Weight {
        ...
        Weight::from_ref_time(21_221_000)
            .saturating_add(DbWeight::get().reads(1))
            .saturating_add(DbWeight::get().writes(1))
    }
}
