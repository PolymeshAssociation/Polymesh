...
impl pallet_treasury::WeightInfo for SubstrateWeight {
    ...
    fn disbursement(b: u32) -> Weight {
        // Minimum execution time: 75_074 nanoseconds.
        Weight::from_ref_time(75_965_000)
            // Standard Error: 47_892
            .saturating_add(Weight::from_ref_time(44_743_221).saturating_mul(b.into()))
    ...
    fn reimbursement() -> Weight {
        // Minimum execution time: 68_003 nanoseconds.
        Weight::from_ref_time(71_869_000)
