...
impl pallet_nft::WeightInfo for SubstrateWeight {
    ...
    fn create_nft_collection(n: u32) -> Weight {
        // Minimum execution time: 111_298 nanoseconds.
        Weight::from_ref_time(113_233_416)
            // Standard Error: 5_997
            .saturating_add(Weight::from_ref_time(2_619_967).saturating_mul(n.into()))
    ...
    fn issue_nft(n: u32) -> Weight {
        // Minimum execution time: 66_991 nanoseconds.
        Weight::from_ref_time(67_885_894)
            // Standard Error: 8_876
            .saturating_add(Weight::from_ref_time(3_409_553).saturating_mul(n.into()))
    ...
    fn redeem_nft(n: u32) -> Weight {
        // Minimum execution time: 76_005 nanoseconds.
        Weight::from_ref_time(80_901_238)
            // Standard Error: 7_006
            .saturating_add(Weight::from_ref_time(1_355_659).saturating_mul(n.into()))
            .saturating_add(DbWeight::get().reads(9))
            .saturating_add(DbWeight::get().reads((1_u64).saturating_mul(n.into())))
    ...
    fn base_nft_transfer(n: u32) -> Weight {
        // Minimum execution time: 136_857 nanoseconds.
        Weight::from_ref_time(129_473_523)
            // Standard Error: 91_610
            .saturating_add(Weight::from_ref_time(14_211_737).saturating_mul(n.into()))
    ...
    fn controller_transfer(n: u32) -> Weight {
        ...
        Weight::from_ref_time(72_175_575)
            // Standard Error: 74_172
            .saturating_add(Weight::from_ref_time(14_654_184).saturating_mul(n.into()))
            .saturating_add(DbWeight::get().reads(9))
            .saturating_add(DbWeight::get().reads((2_u64).saturating_mul(n.into())))
            .saturating_add(DbWeight::get().writes(2))
            .saturating_add(DbWeight::get().writes((3_u64).saturating_mul(n.into())))
