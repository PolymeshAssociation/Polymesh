...
impl pallet_staking::WeightInfo for SubstrateWeight {
    ...
    fn remove_permissioned_validator() -> Weight {
        ...
        Weight::from_ref_time(24_046_000)
            .saturating_add(DbWeight::get().reads(1))
            .saturating_add(DbWeight::get().writes(1))
    }
    ...
    fn change_slashing_allowed_for() -> Weight {
        ...
        Weight::from_ref_time(11_337_000).saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Staking ValidatorCount (r:1 w:0)
    // Proof: Staking ValidatorCount (max_values: Some(1), max_size: Some(4), added: 499, mode: MaxEncodedLen)
    // Storage: Staking PermissionedIdentity (r:1 w:1)
    ...
    fn update_permissioned_validator_intended_count() -> Weight {
        ...
        Weight::from_ref_time(17_637_000)
            .saturating_add(DbWeight::get().reads(2))
            .saturating_add(DbWeight::get().writes(1))
    }
    // Storage: Identity KeyRecords (r:100 w:0)
    ...
    fn chill_from_governance(s: u32) -> Weight {
        // Minimum execution time: 67_181 nanoseconds.
        Weight::from_ref_time(43_362_495)
            // Standard Error: 65_331
            .saturating_add(Weight::from_ref_time(30_593_622).saturating_mul(s.into()))
    ...
    fn set_commission_cap(m: u32) -> Weight {
        // Minimum execution time: 26_249 nanoseconds.
        Weight::from_ref_time(37_579_513)
            // Standard Error: 16_632
            .saturating_add(Weight::from_ref_time(4_561_665).saturating_mul(m.into()))
            .saturating_add(DbWeight::get().reads(3))
