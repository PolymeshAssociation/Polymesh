...
decl_module! {
    pub struct Module<T: Trait<I>, I: Instance=DefaultInstance> for enum Call where origin: <T as frame_system::Trait>::Origin {
        ...
        #[weight = (T::DbWeight::get().reads_writes(6, 2) + 15_000_000, Operational, Pays::Yes)]
        ...
        #[weight = (T::DbWeight::get().reads_writes(1, 1) + 5_000_000, Operational, Pays::Yes)]
        ...
        #[weight = (T::DbWeight::get().reads_writes(6, 2) + 40_000_000, Operational, Pays::Yes)]
