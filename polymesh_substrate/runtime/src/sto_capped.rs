...
decl_module! {
    ...
    pub struct Module<T: Trait> for enum Call where origin: T::Origin {
        ...
        pub fn buy_tokens(origin, _ticker: Vec<u8>, sto_id: u32, value: T::Balance ) -> Result {
            ...
            let token_conversion = <T::TokenBalance as As<T::Balance>>::sa(value).checked_mul(&<T::TokenBalance as As<u64>>::sa(selected_sto.rate)).ok_or("overflow in calculating tokens")?;
