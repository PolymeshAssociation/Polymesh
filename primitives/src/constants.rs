...
pub mod did {
    ...
    pub const DID_REGISTRARS_DID: &[u8; 32] = b"system:customer_due_diligence\0\0\0";
...
pub const DID_PALLET_ID: PalletId = PalletId(*b"pm/cusdd");
...
/// - DIDRegistrar: Issues CDD claims to other identities that need to transact POLYX (treasury, brr, rewards) as well as DID Registrars themselves
...
pub const SYSTEMATIC_ISSUERS: &[SystematicIssuers] = &[
    ...
    SystematicIssuers::DIDRegistrar,
...
impl SystematicIssuers {
    ...
    pub const fn as_bytes(self) -> &'static [u8; 32] {
        match self {
            ...
            SystematicIssuers::DIDRegistrar => did::DID_REGISTRARS_DID,
    ...
    pub const fn as_pallet_id(self) -> PalletId {
        match self {
            ...
            SystematicIssuers::DIDRegistrar => DID_PALLET_ID,
