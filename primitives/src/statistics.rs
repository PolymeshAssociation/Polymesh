...
#[derive(Decode, Encode, TypeInfo, Clone, Debug, Hash, PartialEq, Eq, PartialOrd, Ord)]
...
#[cfg_attr(feature = "std", derive(Serialize, Deserialize))]
#[derive(Decode, Encode, TypeInfo, Clone, Debug, PartialEq, Eq, PartialOrd, Ord, Default)]
